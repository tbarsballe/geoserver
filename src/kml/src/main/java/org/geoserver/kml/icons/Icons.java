...
public class Icons {
    ...
    Integer rotationScale(@Nullable Integer size, @Nullable Double rotation) {
     ...
     */
    public static @Nullable
    Double rotationScale(@Nullable Double size, @Nullable Double rotation) {
        if (size == null) return null;
        if (rotation == null || rotation % 90 == 0) return size; // Save us some trig functions
     ...
     */
    public static @Nullable
    Double getRotation(Graphic g, @Nullable Feature f) {
     ...
     */
    public static @Nullable
    Double getSpecifiedSize(Graphic g, @Nullable Feature f) {
        return g.getSize().evaluate(f, Double.class);
    }

    private static @Nullable
    Icon getIcon(ExternalGraphic eg, @Nullable Feature f) {
     ...
     */
    public static @Nullable
    Integer getExternalSize(ExternalGraphic eg, @Nullable Feature f) {
        Icon i = getIcon(eg, f);
        if (i == null) {
     ...
     */
    public static @Nullable
    Double graphicSize(Graphic g, @Nullable Double rotation, @Nullable Feature f) {
     ...
     */
    public static @Nullable
    Double graphicScale(Graphic g, @Nullable Feature f) {
