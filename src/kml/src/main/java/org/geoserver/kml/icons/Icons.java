...
public class Icons {
   ...
   *     accomodate the rotated square. If {@code null} the rotation will be calculated based on the
   *     feature.
   * @param f
   */
   ...
   *
   * @param g
   * @param f rotation Treat the graphic as a square and rotate it, then find a square big enough to
   *     accomodate the rotated square. If {@code null} the rotation will be calculated based on the
   *     feature.
   */
