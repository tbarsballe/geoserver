...
public class IconPropertiesTest extends IconTestSupport {
  ...
  public void testMultipleFeatureTypeStyle() {
    ...
    final Style s =
        style(
            featureTypeStyle(catchAllRule(symbolizer)), featureTypeStyle(catchAllRule(symbolizer)));
  ...
  public void testLocalFileRotate() throws Exception {
    ...
    assertEquals(
        "http://example.com/styles/foo.png", prop1.href("http://example.com/", null, "test"));
    assertEquals(45.0d, prop1.getHeading(), 0.0001);
    IconProperties prop2 = IconPropertyExtractor.extractProperties(style, fieldIs2);
    assertEquals(
        "http://example.com/styles/foo.png", prop2.href("http://example.com/", null, "test"));
