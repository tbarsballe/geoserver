...
public class IconRendererTest {
  ...
  public void testExternalImage() throws Exception {
    ...
    Graphic g =
        sfact.graphic(
            Arrays.asList(gs), Expression.NIL, Expression.NIL, Expression.NIL, null, null);
    Symbolizer symb = sfact.pointSymbolizer(null, ffact.property(null), null, null, g);
    Rule r =
        sfact.rule(
            null,
  ...
  public void testExternalImageRotated45() throws Exception {
    ...
    Graphic g =
        sfact.graphic(
            Arrays.asList(gs), Expression.NIL, Expression.NIL, ffact.literal(45.0), null, null);
    Symbolizer symb = sfact.pointSymbolizer(null, ffact.property(null), null, null, g);
    Rule r =
        sfact.rule(
            null,
  ...
  public void testBigExternalImage() throws Exception {
    ...
    GraphicalSymbol gs =
        sfact.createExternalGraphic(KMLTest.class.getResource("planet-42.png"), "image/png");
  ...
  public void testBigExternalImageSpecifySize() throws Exception {
    ...
    Graphic g =
        sfact.graphic(
            Arrays.asList(gs), Expression.NIL, ffact.literal(42), Expression.NIL, null, null);
    Symbolizer symb = sfact.pointSymbolizer(null, ffact.property(null), null, null, g);
    Rule r =
        sfact.rule(
            null,
