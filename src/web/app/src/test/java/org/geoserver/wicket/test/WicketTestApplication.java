...
public class WicketTestApplication extends WebApplication {
  ...
  /**
   * Starts a Wicket tester application that will allow for quick interactive testing of the {@link
   * Component} generated by the factory (may be a {@link Page}, in that case the home page will
   * redirect to it).
   *
