...
public class StyleEditPageTest extends GeoServerWicketTestSupport {
  ...
  public void testLoad() throws Exception {
    ...
    String xml =
        tester
            .getComponentFromLastRenderedPage("styleForm:styleEditor")
  ...
  public void testDiscardNewLegendInfo() {
    ...
    tester.executeAjaxEvent(
        "styleForm:context:panel:legendPanel:externalGraphicContainer:showhide:hide", "click");
    tester.assertNoErrorMessage();
  ...
  /**
   * Test that while editing a style, the user can discard a legend, even if the legend has invalid
   * values at the time, and then continue to save the style.
   */
  @Test
  public void testDiscardLegendWithBadValues() throws IOException, URISyntaxException {
    ...
    FormTester form = tester.newFormTester("styleForm", false);
    form.setValue(
        "context:panel:legendPanel:externalGraphicContainer:list:onlineResource", "missing.ong");
  ...
  public void testPreviewSLD11Legend() throws Exception {
    ...
    StyleAdminPanel panel =
        (StyleAdminPanel) tester.getComponentFromLastRenderedPage("styleForm:context:panel");
