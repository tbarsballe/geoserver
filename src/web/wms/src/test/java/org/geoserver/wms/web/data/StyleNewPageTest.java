...
public class StyleNewPageTest extends GeoServerWicketTestSupport {
  ...
  public void testUpload() throws Exception {
    ...
    String sld =
        IOUtils.toString(new FileReader(styleFile)).replaceAll("\r\n", "\n").replaceAll("\r", "\n");
  ...
  public void testLegend() throws Exception {
    ...
    form.setValue(
        "context:panel:legendPanel:externalGraphicContainer:list:onlineResource", "legend.png");
  ...
  public void testLegendAutoFillEmpty() throws Exception {
    ...
    tester.executeAjaxEvent(
        "styleForm:context:panel:legendPanel:externalGraphicContainer:list:autoFill", "click");
  }
