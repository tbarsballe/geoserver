...
public class StylePageSecurityTest extends GeoServerWicketTestSupport {
  ...
  public void testNewCiteCiteWs() throws URISyntaxException, IOException {
    ...
    form.setValue(
        "context:panel:workspace", getCatalog().getWorkspaceByName(MockData.CITE_PREFIX).getId());
    form.submit();
  ...
  public void testNewCiteSfWs() throws URISyntaxException, IOException {
    ...
    form.setValue(
        "context:panel:workspace", getCatalog().getWorkspaceByName(MockData.SF_PREFIX).getId());
    form.submit();
