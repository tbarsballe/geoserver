  ...
  public AttributionLayerConfigPanel(String id, IModel<? extends PublishedInfo> model) {
    ...
    add(
        new TextField<String>(
            "wms.attribution.title", new PropertyModel<String>(model, "attribution.title")));

    final TextField<String> href =
        new TextField<String>(
            "wms.attribution.href", new PropertyModel<String>(model, "attribution.href"));
    ...
    final TextField<String> logo =
        new TextField<String>(
            "wms.attribution.logo", new PropertyModel<String>(model, "attribution.logoURL"));
    ...
    final TextField<String> type =
        new TextField<String>(
            "wms.attribution.type", new PropertyModel<String>(model, "attribution.logoType"));
