...
public class DataPanel extends StyleEditTabPanel {
    ...
    public DataPanel(String id, CompoundPropertyModel<? extends StyleInfo> model,
            AbstractStylePage parent)
        throws IOException
    {
        super(id, model, parent);
        this.featureTypeId = parent.getLayer().getId();
        
        Feature sample = getSampleFeature((FeatureTypeInfo) parent.getLayer().getResource());
