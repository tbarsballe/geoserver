          ...
          protected void populateItem(final ListItem<AuthorityURLInfo> item) {
            ...
            authName =
                new TextField<String>(
                    "authName", new PropertyModel<String>(item.getModel(), "name"));
            ...
            authURL =
                new TextField<String>(
                    "authorityURL", new PropertyModel<String>(item.getModel(), "href"));
                ...
                new AjaxLink<Integer>("removeLink", new Model<Integer>(item.getIndex())) {
                  ...
                  public void onClick(AjaxRequestTarget target) {
                    List<AuthorityURLInfo> list =
                        new ArrayList<AuthorityURLInfo>(authorityURLs.getModelObject());
