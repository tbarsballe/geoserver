...
public class LayerIdentifierListEditor extends FormComponentPanel<List<LayerIdentifierInfo>> {
  ...
  /**
   * Sets a list of base authorities to populate the authority names drop down regardless of whether
   * they're defined on this specific layer or not (i.e., the root layer authorities when editing
   * the identifiers for a non root layer)
   */
    ...
    identifiers =
        new ListView<LayerIdentifierInfo>(
          ...
          protected void populateItem(final ListItem<LayerIdentifierInfo> item) {
            ...
            authorities =
                new DropDownChoice<String>("authority", authModel, authNamesModel.getObject());
            ...
            identifier =
                new TextField<String>(
                    "identifier", new PropertyModel<String>(item.getModel(), "identifier"));
            ...
            AjaxLink<Integer> link =
                new AjaxLink<Integer>("removeLink", new Model<Integer>(item.getIndex())) {
                  ...
                  public void onClick(AjaxRequestTarget target) {
                    List<LayerIdentifierInfo> list =
                        new ArrayList<LayerIdentifierInfo>(identifiers.getModelObject());
