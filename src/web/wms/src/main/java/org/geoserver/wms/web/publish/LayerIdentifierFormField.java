    ...
    add(
        (authority =
            new TextField<String>(
                "authority", new PropertyModel<String>(identifierModel, "authority"))));
    add(
        (identifier =
            new TextField<String>(
                "identifier", new PropertyModel<String>(identifierModel, "identifier"))));
        ...
        new IValidator<LayerIdentifierInfo>() {
          ...
          public void validate(IValidatable<LayerIdentifierInfo> arg) {
            ...
            if (value.getAuthority() == null || value.getIdentifier() == null) {
              ...
              error.setMessage(
                  new ResourceModel("LayerIdentifierFormField.validationError").getObject());
              arg.error(error);
            }
          }
        });
