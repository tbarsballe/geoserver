...
public class ReprojectPageTest extends GeoServerWicketTestSupport {
  ...
  public void testReprojectPoint() {
    ...
    String tx =
        tester.getComponentFromLastRenderedPage("form:targetGeom").getDefaultModelObjectAsString();
  ...
  public void testPageParams() {
    ...
    String source =
        tester
            .getComponentFromLastRenderedPage("form:sourceCRS:srs")
            .getDefaultModelObjectAsString();
    String target =
        tester
            .getComponentFromLastRenderedPage("form:targetCRS:srs")
            .getDefaultModelObjectAsString();
