...
public abstract class SQLViewAbstractPage extends GeoServerSecuredPage {
  ...
  public SQLViewAbstractPage(
        ...
        new GeoServerTablePanel<Parameter>("parameters", paramProvider, true) {
          ...
          protected Component getComponentForProperty(
            ...
            TextField<String> text =
                new TextField<String>("text", (IModel<String>) property.getModel(itemModel));
            text.setLabel(
                new ParamResourceModel("th." + property.getName(), SQLViewAbstractPage.this));
    ...
    form.add(
        guessCheckbox =
            new CheckBox(
                "guessGeometrySrid", new PropertyModel<Boolean>(this, "guessGeometrySrid")));
    ...
    attributes =
        new GeoServerTablePanel<SQLViewAttribute>("attributes", attProvider) {
          ...
          protected Component getComponentForProperty(
            ...
            boolean isGeometry =
                att.getType() != null && Geometry.class.isAssignableFrom(att.getType());
  ...
  class ViewNameValidator implements IValidator<String> {
    ...
    public void validate(IValidatable<String> validatable) {
      ...
      for (FeatureTypeInfo curr : ftis) {
        VirtualTable currvt =
            curr.getMetadata().get(FeatureTypeInfo.JDBC_VIRTUAL_TABLE, VirtualTable.class);
        if (currvt != null) {
