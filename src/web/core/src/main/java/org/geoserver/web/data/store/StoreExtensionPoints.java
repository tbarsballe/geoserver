...
public class StoreExtensionPoints {
   ...
   * @return a custom {@link StoreEditPanel} if there's one declared for the given store type, or a
  ...
  public static StoreEditPanel getStoreEditPanel(
    ...
    try {
      ...
      throw new RuntimeException(
          "Cannot instantiate extension point contributor " + componentClass.getName(), e);
    }
