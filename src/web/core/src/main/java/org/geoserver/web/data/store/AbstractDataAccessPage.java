...
abstract class AbstractDataAccessPage extends GeoServerSecuredPage {
  ...
  protected void initUI(final DataStoreInfo storeInfo) throws IllegalArgumentException {
    ...
    try {
      ...
      String msg =
          (String) new ResourceModel("AbstractDataAccessPage.cantGetDataStoreFactory").getObject();
      msg += ": " + e.getMessage();
...

    {
      ...
      storeEditPanel =
          StoreExtensionPoints.getStoreEditPanel("parametersPanel", paramsForm, storeInfo, app);
    }
   ...
   * perform the action over the catalog, whether it is adding a new {@link DataStoreInfo} or saving
   * the edits to an existing onefinal StoreEditPanel
   *
          ...
          protected void onUpdate(AjaxRequestTarget target) {
            ...
            if (!namespaceLookupOccurred) {
              ...
              Component paramsPanel =
                  AbstractDataAccessPage.this.get("dataStoreForm:parametersPanel");
