...
public class LayerGroupEntryPanel extends Panel {
  ...
  public LayerGroupEntryPanel(
    ...
    add(
        layerTable =
            new ReorderableTablePanel<LayerGroupEntry>("layers", items, propertiesModel) {
    ...
    add(
        new AjaxLink<LayerGroupInfo>("addLayerGroup") {
          ...
          public void onClick(AjaxRequestTarget target) {
            ...
            popupWindow.setContent(
                new LayerGroupListPanel(popupWindow.getContentId(), groupWorkspace.getObject()) {
    ...
    add(
        new AjaxLink<LayerGroupInfo>("addStyleGroup") {
          ...
          public void onClick(AjaxRequestTarget target) {
            ...
            popupWindow.setContent(
                new StyleListPanel(
                    popupWindow.getContentId(), new StyleListPanel.StyleListProvider()) {
    ...
    link.getImage()
        .add(
            new AttributeModifier(
                "alt", new ParamResourceModel("LayerGroupEditPage.th.remove", link)));
    return link;
  }
