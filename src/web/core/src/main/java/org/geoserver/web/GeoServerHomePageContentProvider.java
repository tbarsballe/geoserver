...
public interface GeoServerHomePageContentProvider {
   ...
   *
   * <p>Note {@code null} is a valid return value, so that implementations may opt not to contribute
   ...
   * @return a component suitable to be contained by the home page central body, or {@code null} if
   *     no extra content is provided.
   */
