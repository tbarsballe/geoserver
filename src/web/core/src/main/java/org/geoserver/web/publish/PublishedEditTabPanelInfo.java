...
public abstract class PublishedEditTabPanelInfo<T extends PublishedInfo>
   ...
   * different model object that the page's layer and resource models (for example, because it edits
   * and saves related information not directly attached to the layer/resource); if such is the
   * case, this method shall return the model to be passed to the {@link PublishedEditTabPanel}
   * constructor.
   *
