...
public class GlobalSettingsPage extends ServerAdminPage {
  ...
  public GlobalSettingsPage() {
    ...
    form.add(
        new CheckBox(
            "stdOutLogging", new PropertyModel<Boolean>(loggingInfoModel, "stdOutLogging")));
    form.add(
        new TextField<String>(
            "loggingLocation", new PropertyModel<String>(loggingInfoModel, "location")));
  ...
  private void logLevelsAppend(Form<GeoServerInfo> form, IModel<LoggingInfo> loggingInfoModel) {
    ...
    form.add(
        new ListChoice<String>(
            "log4jConfigFile", new PropertyModel<String>(loggingInfoModel, "level"), logProfiles));
  }
