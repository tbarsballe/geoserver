...
public abstract class PublishedConfigurationPage<T extends PublishedInfo>
   ...
   * PublishedEditTabPanelInfo#createOwnModel} will return a non null model and well pass it back to
   * the concrete LayerEditTabPanel constructor. This is so because LayerEditTabPanel are re-created
   * everytime the user switches tabs.
   */
  ...
  public void setSelectedTab(Class<? extends PublishedEditTabPanel<?>> selectedTabClass) {
    ...
    selectedTabIndex =
        new ArrayList<Class<? extends PublishedEditTabPanel<T>>>(tabPanelCustomModels.keySet())
