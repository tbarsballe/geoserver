        ...
        new GeoServerTablePanel<CoverageDimensionInfo>(
          ...
          protected Component getComponentForProperty(
            ...
            if ("band".equals(property.getName())) {
              ...
              Component text =
                  new TextField<>("bandtext", (IModel<String>) property.getModel(itemModel));
              f.add(text);
              return f;
            }
            if ("nullValues".equals(property.getName())) {
              ...
              Component text =
                  new DecimalListTextField("nulltext", (IModel<List>) property.getModel(itemModel));
              f.add(text);
              return f;
            }
            ...
            if ("minRange".equals(property.getName())) {
              ...
              Component min =
                  new DecimalTextField("minRange", (IModel<Double>) property.getModel(itemModel));
              f.add(min);
              return f;
            }
            if ("maxRange".equals(property.getName())) {
              ...
              Component max =
                  new DecimalTextField("maxRange", (IModel<Double>) property.getModel(itemModel));
              f.add(max);
              return f;
            }
              ...
              if (metadata != null && metadata.containsKey(CoverageView.COVERAGE_VIEW)) {
                GridCoverage2DReader reader =
                    (GridCoverage2DReader)
                        catalog
                            .getResourcePool()
                            .getGridCoverageReader(ci, nativeName, GeoTools.getDefaultHints());
