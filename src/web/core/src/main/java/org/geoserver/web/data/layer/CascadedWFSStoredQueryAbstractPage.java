...
public abstract class CascadedWFSStoredQueryAbstractPage extends GeoServerSecuredPage {
  ...
  public CascadedWFSStoredQueryAbstractPage(String workspaceName, String storeName, String typeName)
    ...
    parameters =
        new GeoServerTablePanel<StoredQueryParameterAttribute>("parameters", parameterProvider) {
          /** serialVersionUID */
          ...
          protected Component getComponentForProperty(
            ...
            if (property == ATTR_MAPTYPE) {
              Fragment f =
                  new Fragment(id, "parameterMappingType", CascadedWFSStoredQueryAbstractPage.this);
              ...
              Fragment f =
                  new Fragment(
                      id, "parameterMappingValue", CascadedWFSStoredQueryAbstractPage.this);

              TextField<String> textField =
                  new TextField<>("text", new PropertyModel<>(itemModel, "value"));
              f.add(textField);
