...
public class CodeMirrorEditor extends FormComponentPanel<String> {
  ...
  private boolean isCodeMirrorSupported() {
    ...
    if (clientProperties.isBrowserInternetExplorer()) {
      ...
      enableCodeMirror =
          clientProperties.getBrowserVersionMajor() >= 8 || props.getBrowserVersionMajor() >= 8;
      ...
      enableCodeMirror =
          clientProperties.getBrowserVersionMajor() >= 3 || props.getBrowserVersionMajor() >= 3;
      ...
      enableCodeMirror =
          clientProperties.getBrowserVersionMajor() >= 9 || props.getBrowserVersionMajor() >= 9;
    }
  ...
  public void setMode(String mode) {
    ...
    if (requestTarget != null) {
      String javascript =
          "document.gsEditors." + editor.getMarkupId() + ".setOption('mode', '" + mode + "');";
