...
public class HeaderContribution {
  ...
  /**
   * Returns the resource reference to the javascript for the header contribution, or null if there
   * is no javascript contribution.
   */
  ...
  /**
   * Returns the resource reference to a replacement favicon for the header contribution, or null if
   * there is no favicon replacement
   */
