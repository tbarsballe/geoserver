...
public abstract class ReorderableTablePanel<T> extends GeoServerTablePanel<T> {
  ...
  /**
   * Deprecated, provide a loadable model for properties instead which ensures always the same exact
   * property objects are returned (or use equality by name in the getComponentForProperty method)
   */
