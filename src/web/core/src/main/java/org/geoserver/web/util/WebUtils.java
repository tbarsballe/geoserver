...
public class WebUtils {
   ...
   * to be localized and you don't have access to a Component instance. Use with care, in most cases
   * you should be able to localize your messages directly in pages or components.
   *
   * @param key
   * @param model
   * @param params
