...
public abstract class ComponentInfo<C extends Component> implements Serializable {
   ...
   *
   * <p>The exact way this title is used depends one the component. For instance if the component is
   * a page, the title could be the used for a link to the page. If the component is a panel in a
   * tabbed panel, the title might be the label on the tab.
   */
