...
public class DeveloperToolbar extends Panel {
  ...
  public DeveloperToolbar(String id) {
    ...
    final AjaxCheckBox wicketPaths =
        new AjaxCheckBox(
            "wicketPaths", new PropertyModel(gsApp, "debugSettings.outputComponentPath")) {
    ...
    wicketIds =
        new AjaxCheckBox("wicketIds", new PropertyModel(gsApp, "markupSettings.stripWicketTags")) {
    ...
    add(
        new AjaxCheckBox(
            "ajaxDebug", new PropertyModel(gsApp, "debugSettings.ajaxDebugModeEnabled")) {
