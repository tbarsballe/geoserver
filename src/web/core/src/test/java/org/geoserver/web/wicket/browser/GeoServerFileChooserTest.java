...
public class GeoServerFileChooserTest extends GeoServerWicketTestSupport {
  ...
  public void testAutocompleteDataDirectory() throws Exception {
    ...
    // for the sake of checking, find a specific style with a file extension filter (the dd contains
    // both
  ...
  public void testAutocompleteDirectories() throws Exception {
    ...
    assertThat(
        values, hasItem("file://" + new File(rootPath, MockData.CITE_PREFIX).getAbsolutePath()));
    assertThat(
        values, hasItem("file://" + new File(rootPath, MockData.SF_PREFIX).getAbsolutePath()));
  }
}
