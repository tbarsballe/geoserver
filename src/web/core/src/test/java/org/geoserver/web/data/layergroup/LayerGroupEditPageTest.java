...
public class LayerGroupEditPageTest extends LayerGroupBaseTest {
  ...
  public void testMissingName() {
    ...
    tester.assertErrorMessages(
        (Serializable[]) new String[] {"Field 'Name' is required.", "Field 'Bounds' is required."});
  }
  ...
  public void testLayerLink() {
    ...
    tester.assertComponent(
        "publishedinfo:tabs:panel:layers:popup:content:listContainer:items", DataView.class);
