...
public abstract class AbstractAdminPrivilegeTest extends GeoServerWicketTestSupport {
  ...
  public void testLayerGroupEditPageGlobal() throws Exception {
    ...
    assertFalse(
        tester.getComponentFromLastRenderedPage("publishedinfo:tabs:panel:name").isEnabled());
    assertFalse(
        tester.getComponentFromLastRenderedPage("publishedinfo:tabs:panel:workspace").isEnabled());
