...
public class ConfirmRemovalPanelTest extends GeoServerWicketTestSupport {
  ...
  public void testRemoveWorkspace() {
    ...
    String layers =
        tester
            .getComponentFromLastRenderedPage("form:panel:removedObjects:layersRemoved:layers")
  ...
  public void testRemoveLayer() {
    ...
    assertFalse(
        tester.getLastRenderedPage().get("form:panel:removedObjects:storesRemoved").isVisible());
