...
public class DataAccessEditPageTest extends GeoServerWicketTestSupport {
   ...
   * well as the namespace of its previously configured resources @REVISIT: this test fails on maven
   * but is ok on eclipse...
   */
  ...
  public void testEditDettached() throws Exception {
    ...
    try {
      ...
      form.setValue(
          "parametersPanel:parameters:0:parameterPanel:border:border_body:paramValue", "/foo");
