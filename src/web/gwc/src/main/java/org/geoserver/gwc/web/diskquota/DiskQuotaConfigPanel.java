...
public class DiskQuotaConfigPanel extends Panel {
  ...
  private void addDiskQuotaStoreChooser(
    ...
    final DropDownChoice<String> quotaStoreChooser =
        new DropDownChoice<String>(
            "diskQuotaStore", storeNameModel, storeNames, new LocalizedChoiceRenderer(this));
  ...
  private void addGlobalQuotaConfig(
    ...
    Object[] progressMessageParams = {
      globalUsedQuotaModel.getObject().toNiceString(), globalQuotaModel.getObject().toNiceString()
    };
  ...
  private void addDiskQuotaIntegrationEnablement(IModel<DiskQuotaConfig> diskQuotaModel) {
    ...
    CheckBox diskQuotaIntegration =
        checkbox(
            "enableDiskQuota", quotaEnablementModel, "DiskQuotaConfigPanel.enableDiskQuota.title");
  ...
  private void addGlobalQuotaStatusBar(
    ...
    StorageUnit biggerUnit =
        bestUnitForLimit.compareTo(bestUnitForUsed) > 0 ? bestUnitForLimit : bestUnitForUsed;
    ...
    StatusBar statusBar =
        new StatusBar("globalQuotaProgressBar", limitModel, usedModel, progressMessageModel);
