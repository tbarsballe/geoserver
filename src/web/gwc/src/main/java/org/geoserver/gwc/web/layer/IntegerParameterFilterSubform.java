...
public class IntegerParameterFilterSubform
  ...
  public IntegerParameterFilterSubform(String id, IModel<IntegerParameterFilter> model) {
    ...
    defaultValue =
        new TextField<String>("defaultValue", new PropertyModel<String>(model, "defaultValue"));
    add(defaultValue);

    final TextArea<List<Integer>> values;
    values =
        new TextArea<List<Integer>>("values", new PropertyModel<List<Integer>>(model, "values")) {
    ...
    threshold =
        new TextField<Integer>("threshold", new PropertyModel<Integer>(model, "threshold")) {
