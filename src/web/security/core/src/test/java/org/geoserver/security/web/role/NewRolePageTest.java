...
public class NewRolePageTest extends AbstractSecurityWicketTestSupport {
  ...
  protected void doTestFill() throws Exception {
    ...
    tester.startPage(
        page = (NewRolePage) new NewRolePage(getRoleServiceName()).setReturnPage(returnPage));
  ...
  public void testInvalidWorkflow() throws Exception {
    ...
    try {
      tester.startPage(
          page = (NewRolePage) new NewRolePage(getRORoleServiceName()).setReturnPage(returnPage));
