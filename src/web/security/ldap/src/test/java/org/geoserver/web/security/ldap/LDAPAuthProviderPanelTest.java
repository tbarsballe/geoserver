...
public class LDAPAuthProviderPanelTest extends AbstractSecurityWicketTestSupport {
        ...
        new LDAPFormTestPage(
            new ComponentBuilder() {
              ...
              public Component buildComponent(String id) {
                ...
                return current =
                    new LDAPAuthProviderPanel(id, new Model<LDAPSecurityServiceConfig>(config));
              };
            },
  ...
  private void testSuccessfulConnection() throws Exception {
    ...
    String success =
        new StringResourceModel(
                LDAPAuthProviderPanel.class.getSimpleName() + ".connectionSuccessful")
            .getObject();
  ...
  private void authenticate(String username, String password) {
    ...
    tester
        .getComponentFromLastRenderedPage("form:panel:testCx")
