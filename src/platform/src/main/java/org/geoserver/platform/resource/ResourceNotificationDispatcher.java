...
public interface ResourceNotificationDispatcher {
   ...
   *   <li>user_projections/epsg.properties: listener notified for any change to the epsg.properties
   *       resource
   * </ul>
   *
   ...
   * Send notification.
   *
   * <p>Events should be propagated to children and parents automatically where applicable,to avoid
   * unnecessary communication between GeoServer instances in a clustered environment. (Delete
   * notifications are propagated to their children. All operations are propagated to their
   * parents.) See {@link SimpleResourceNotificationDispatcher} for an example.
   *
