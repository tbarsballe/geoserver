...
public class SimpleResourceNotificationDispatcher implements ResourceNotificationDispatcher {
  ...
  public void changed(ResourceNotification notification) {
    ...
    // if delete, propagate delete notifications to children, which can be found in the events (see
    // {@link createEvents})
    ...
    // if create, propagate CREATE events to its created parents, which can be found in the events
