...
public interface ResourceStore {
   ...
   * directory is not provided). This implementation prevents client code from requiring null checks
   * on {@link ResourceStore#get(String)}. IllegalStateException are thrown by in(), out() and
   * file() which are the usual methods clients require error handling.
   */
   ...
   * content (or if a security check) prevents the resource from being removed <code>false</code> is
   * returned.
   *
