...
public class Paths {
  ...
  /**
   * Convert a filePath to resource path (starting from the provided path). Absolute file paths are
   * not supported, and the final resource must still be within the data directory.
   *
   * <p>This method converts file paths (using {@link File#separator}) to the URL style paths used
   * for {@link ResourceStore#get(String)}.
   *
