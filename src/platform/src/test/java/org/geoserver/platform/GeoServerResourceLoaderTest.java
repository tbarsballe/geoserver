...
public class GeoServerResourceLoaderTest {
  ...
  /**
   * Test {@link GeoServerResourceLoader#lookupGeoServerDataDirectory(ServletContext)} with a single
   * required file that exists specified in the Java environment.
   */
  @Test
  ...
  /**
   * Test {@link GeoServerResourceLoader#lookupGeoServerDataDirectory(ServletContext)} with a single
   * required file that does not exist specified in the Java environment.
   */
  @Test
  ...
  /**
   * Test {@link GeoServerResourceLoader#lookupGeoServerDataDirectory(ServletContext)} with a single
   * required file that does not exist specified in the servlet context.
   */
  @Test
