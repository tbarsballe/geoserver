...
public class GeoJSONBuilder extends JSONBuilder {
  ...
  /**
   * Write a java.util.List out as a JSON Array. The values of the array will be converted using ike
   * standard primitive conversions. If the list contains List or Map objects, they will be
   ...
   * well as {@code java.util.Calendar} instances as ISO 8601 strings. In addition handles rounding
   * numbers to the specified number of decimal points.
   *
