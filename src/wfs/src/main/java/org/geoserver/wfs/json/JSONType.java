...
public enum JSONType {
  ...
  /**
   * Can be used when {@link #jsonp} format is specified to resolve the callback parameter into the
   * FORMAT_OPTIONS map
   *
   ...
   * @return null to use generated feature id, empty string to surpress id generation, or attribute
   *     to use
   */
