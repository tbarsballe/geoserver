...
public class RoundingUtil {
  ...
  public static double round(double value, int numDecimals) {
    // Technically this code will handle -numDecimals by rounding digits to the left of the decimal
    // point, but that is
    ...
    // Prevent us exceeding the maximum precision.  We make sure the minimum spacing between values
    // is sufficient
