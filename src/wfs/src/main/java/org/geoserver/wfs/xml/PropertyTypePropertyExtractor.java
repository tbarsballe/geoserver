...
public class PropertyTypePropertyExtractor implements PropertyExtractor {
  ...
  public List properties(Object object, XSDElementDeclaration element) {
    ...
    properties.add(
        new Object[] {
          Schemas.getChildElementParticle(element.getType(), "Name", false), property.getName()
        });
    ...
    if (type != null) {
      ...
      Object[] p =
          new Object[] {
            Schemas.getChildElementParticle(element.getType(), "Value", false), property.getValue()
          };
      properties.add(p);
    }
