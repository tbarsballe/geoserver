...
public class QNameKvpParser extends FlatKvpParser {
   ...
   *     not match a namespace from {@code catalog}, an exception will be thrown, otherwise a {@code
   *     QName} with prefix and localName but without namespace will be returned.
   */
   ...
   * }.
   *
   * <p>If the latter form is supplied the QName is given the default namespace as specified in the
   * catalog.
   */
