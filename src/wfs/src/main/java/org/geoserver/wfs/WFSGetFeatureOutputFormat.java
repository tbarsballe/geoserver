...
public abstract class WFSGetFeatureOutputFormat extends WFSResponse {
  ...
  /**
   * Returns the list of output format names generated by this format, for inclusion in the WFS 1.0
   * capabilities document as XML element names
   */
   ...
   * @return <code>true</code> if the output format can handle the operation, otherwise <code>false
   *     </code>
   */
