...
public interface TransactionElementHandler {
   ...
   * @param featureStores map from {@link QName} to {@link FeatureStore}, where the keys do contain
   *     all the feature type names reported by {@link #getTypeNames(EObject)}
