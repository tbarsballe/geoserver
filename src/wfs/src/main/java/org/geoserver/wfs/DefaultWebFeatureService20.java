...
public class DefaultWebFeatureService20 implements WebFeatureService20, ApplicationContextAware {
  ...
  public LockFeatureResponseType lockFeature(LockFeatureType request) throws WFSException {
    ...
    if (request.getLockId() != null) {
      ...
      // ... expand the typenames from feature id filters (the wrappers will modify the underlying
      // object
      List<Query> queries =
      ...
      // ... lock cannot handle queries with multiple target typenames, need to expand them into
      // separate queries
