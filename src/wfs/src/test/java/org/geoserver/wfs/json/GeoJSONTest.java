...
public class GeoJSONTest extends WFSTestSupport {
  ...
  protected void setUpInternal(SystemTestData data) throws Exception {
    ...
    // A feature with a constant test setup for testing geometry/geometry_name consistency with null
    // geometries
    data.addVectorLayer(
  ...
  public void testGeometryAndGeometryNameConsistency() throws Exception {
    ...
    assertFalse(
        "geom_a must not be present, its the default geom", properties.containsKey("geom_a"));
    ...
    assertEquals(
        "no geometries present, 1st still default", "geom_a", feature.getString("geometry_name"));
    geometry = feature.getJSONObject("geometry");
    assertTrue(geometry.isNullObject());
    properties = feature.getJSONObject("properties");
    assertFalse(
