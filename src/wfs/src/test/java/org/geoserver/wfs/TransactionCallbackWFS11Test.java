...
public class TransactionCallbackWFS11Test extends WFSTestSupport {
  ...
  public void testUpdate() throws Exception {
    ...
    assertXpathEvaluatesTo(
        TransactionCallbackTester.FOLSOM_STREET, "//cite:RoadSegments/cite:NAME", roadSegments);
  }
  ...
  public void testDelete() throws Exception {
    ...
    Document roadSegments =
        getAsDOM("wfs?service=WFS&version=1.1.0&request=GetFeature&typeName=cite:RoadSegments");
    // print(roadSegments);
