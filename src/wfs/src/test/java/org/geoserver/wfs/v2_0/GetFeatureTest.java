...
public class GetFeatureTest extends WFS20TestSupport {
  ...
  public void testGetWithCount() throws Exception {
    Document dom =
        getAsDOM("wfs?request=GetFeature&typenames=cdf:Fifteen&version=2.0.0&service=wfs&count=5");
  ...
  public void testWithGMLProperties() throws Exception {
    Document dom =
        getAsDOM("wfs?request=getfeature&service=wfs&version=2.0.0&typename=sf:WithGMLProperties");
    assertGML32(dom);
  ...
  public void testLayerQualified() throws Exception {
    ...
    Document dom =
        getAsDOM("cdf/Seven/wfs?request=GetFeature&typename=cdf:Fifteen&version=2.0.0&service=wfs");
  ...
  /**
   * Check that a Filter 2.0 {@code fes:PropertyIsLike} returns the expected number of Buildings for
   * a given {@code matchCase}.
   *
