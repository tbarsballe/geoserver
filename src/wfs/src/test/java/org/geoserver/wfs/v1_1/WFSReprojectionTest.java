...
public class WFSReprojectionTest extends WFSTestSupport {
  ...
  public void testGetFeatureWithAutoBoxGet() throws Exception {
    ...
    try {
      ...
      String lc =
          getFirstElementByTagName(envelope, "gml:lowerCorner").getFirstChild().getNodeValue();
      String uc =
          getFirstElementByTagName(envelope, "gml:upperCorner").getFirstChild().getNodeValue();
      double[] c =
          new double[] {
