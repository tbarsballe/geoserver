...
public class GetFeatureTest extends WFSTestSupport {
  ...
  public void testAlienNamespace() throws Exception {
    ...
    Document doc =
        getAsDOM("wfs?request=GetFeature&typename=youdontknowme:Fifteen&version=1.0.0&service=wfs");
  ...
  public void testLayerQualified() throws Exception {
    ...
    Document doc =
        getAsDOM("cdf/Fifteen/wfs?request=GetFeature&typename=cdf:Seven&version=1.0.0&service=wfs");
    XMLAssert.assertXpathEvaluatesTo("1", "count(//ogc:ServiceException)", doc);
  }
  ...
  public void testRequestDisabledStore() throws Exception {
    ...
    try {
      ...
      catalog.save(store);
      Document doc =
          getAsDOM("wfs?service=WFS&version=1.0.0&request=GetFeature&typename=cdf:Fifteen");
      // print(doc);
      XMLAssert.assertXpathEvaluatesTo("1", "count(//ogc:ServiceException)", doc);
      XMLAssert.assertXpathEvaluatesTo(
