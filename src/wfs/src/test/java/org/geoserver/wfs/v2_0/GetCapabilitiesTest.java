...
public class GetCapabilitiesTest extends WFS20TestSupport {
  ...
  public void testLayerQualified() throws Exception {
    // filter on an existing namespace
    Document doc =
        getAsDOM("sf/PrimitiveGeoFeature/wfs?service=WFS&version=2.0.0&request=getCapabilities");
  ...
  public void testAcceptFormats() throws Exception {
    ...
    response =
        getAsServletResponse("wfs?request=GetCapabilities&version=2.0.0&acceptformats=text/xml");
  ...
  public void testSections(
      ...
      throws Exception {
    Document dom =
        getAsDOM("wfs?service=WFS&version=2.0.0&request=GetCapabilities&sections=" + sections);
    // print(dom);
