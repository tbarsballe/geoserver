...
public class GeometrylessTest extends WFSTestSupport {
  ...
  public void testGetFeature10() throws Exception {
    Document doc =
        getAsDOM("wfs?request=GetFeature&typename=cite:Geometryless&version=1.0.0&service=wfs");
  ...
  public void testGetFeature11() throws Exception {
    Document doc =
        getAsDOM("wfs?request=GetFeature&typename=cite:Geometryless&version=1.1.0&service=wfs");
    assertEquals("wfs:FeatureCollection", doc.getDocumentElement().getNodeName());
    //        print(doc);
