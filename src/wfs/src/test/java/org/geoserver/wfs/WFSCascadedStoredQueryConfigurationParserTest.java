...
public class WFSCascadedStoredQueryConfigurationParserTest {
  ...
  public void testDeserialization() throws Exception {
    ...
    ParameterMappingExpressionValue map1 =
        (ParameterMappingExpressionValue) configuration.getStoredQueryParameterMappings().get(0);
    ...
    ParameterMappingDefaultValue map2 =
        (ParameterMappingDefaultValue) configuration.getStoredQueryParameterMappings().get(1);
