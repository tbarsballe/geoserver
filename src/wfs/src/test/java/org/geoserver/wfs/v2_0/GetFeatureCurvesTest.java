...
public class GetFeatureCurvesTest extends WFS20TestSupport {
  ...
  protected void setUpInternal(SystemTestData testData) throws Exception {
    ...
    testData.addVectorLayer(
        CURVELINES, Collections.EMPTY_MAP, "curvelines.properties", MockData.class, getCatalog());
    testData.addVectorLayer(
        CURVEMULTILINES,
  ...
  public void testCurveLine() throws Exception {
    Document dom =
        getAsDOM(
            "wfs?service=wfs&version=2.0&request=GetFeature&typeName=" + getLayerId(CURVELINES));
    // print(dom);
