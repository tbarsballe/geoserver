...
public class Transaction3DTest extends WFSTestSupport {
  ...
  public void testInsert3DLinestring() throws Exception {
    ...
    assertEquals(
        "3", xpath.evaluate("//cite:full3d/cite:geom/gml:LineString/@srsDimension", featureDom));
    assertEquals(
  ...
  public void testInsert3DPolygon() throws Exception {
    ...
    assertEquals(
        "3", xpath.evaluate("//cite:full3d/cite:geom/gml:Polygon/@srsDimension", featureDom));
    assertEquals(
