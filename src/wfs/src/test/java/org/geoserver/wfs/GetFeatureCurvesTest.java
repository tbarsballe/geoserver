...
public class GetFeatureCurvesTest extends WFSCurvesTestSupport {
  ...
  public void testLinearizeWFS10() throws Exception {
    Document dom =
        getAsDOM(
            "wfs?service=wfs&version=1.0&request=GetFeature&typeName=" + getLayerId(CURVELINES));
    // print(dom);
  ...
  public void testCurveLineWFS11() throws Exception {
    Document dom =
        getAsDOM(
            "wfs?service=wfs&version=1.1&request=GetFeature&typeName=" + getLayerId(CURVELINES));
    // print(dom);
