...
public class GeoServerTileLayerTest {
  ...
  public void testGetTilePreconditions() throws Exception {
    ...
    ConveyorTile tile =
        new ConveyorTile(storageBroker, layerInfoTileLayer.getName(), servletReq, servletResp);
  ...
  public void testGetMetadataUrlsFromLayer() throws MalformedURLException {
    ...
    assertThat(
        metadata.get(0).getUrl(), is(new URL("http://localhost:8080/geoserver/metadata-content")));
  }
