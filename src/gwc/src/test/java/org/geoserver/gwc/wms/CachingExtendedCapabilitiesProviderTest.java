...
public class CachingExtendedCapabilitiesProviderTest extends GeoServerSystemTestSupport {
  ...
  public void testCapabilitiesContributedInternalDTD() throws Exception {
    ...
    assertEquals(
        "../wms/src/test/resources/geoserver/schemas/wms/1.1.1/WMS_MS_Capabilities.dtd", systemId);
    ...
    assertTrue(
        internalSubset, internalSubset.trim().startsWith("<!ELEMENT VendorSpecificCapabilities"));
