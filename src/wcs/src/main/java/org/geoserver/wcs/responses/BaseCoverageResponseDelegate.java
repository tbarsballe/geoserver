...
public abstract class BaseCoverageResponseDelegate implements CoverageResponseDelegate {
  ...
  /**
   * Provides a fallback, a value that looks like a GMLCOV conformance class. Delegates that can be
   * actually associated to an official conformance class should override this method
   */
