...
public class GeoTIFFCoverageResponseDelegate extends BaseCoverageResponseDelegate
   ...
   * @param econdingParameters a {@link Map} of {@link String} keys with {@link String} values to
   *     hold the encoding parameters.
   * @param wp an instance of {@link GeoTiffWriteParams} to be massaged as per the provided encoding
   *     parameters.
   ...
   * @throws WcsException in case there are invalid or unsupported options.
   */
  private void handleCompression(Map<String, String> econdingParameters, GeoTiffWriterHelper helper)
      throws WcsException {
    // compression
