...
public class ResourcePoolTest extends GeoServerSystemTestSupport {
  ...
  protected void onSetUp(SystemTestData testData) throws Exception {
    ...
    testData.addStyle(
        "relative_protocol", "se_relativepath_protocol.sld", ResourcePoolTest.class, getCatalog());
  ...
  public void testWmsCascadeEntityExpansion() throws Exception {
    ...
    try {
      ...
      assertFalse(
          "Expect external entity cause", cause != null && cause instanceof FileNotFoundException);
    }
  ...
  public void testEmptySort() throws IOException, IllegalAccessException {
    ...
    // the above call used to add a SortedSimpleFeatureCollection wrapper that in turn killed some
    // visit optimizations
