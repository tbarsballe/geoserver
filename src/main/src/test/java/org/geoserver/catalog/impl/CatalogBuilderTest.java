...
public class CatalogBuilderTest extends GeoServerMockTestSupport {
  ...
  public void testWMSLayer111() throws Exception {
    ...
    try {
      ...
      client.expectGet(
          capsURL, new MockHttpResponse(getClass().getResource("caps111.xml"), "text/xml"));
  ...
  public void testWMSLayer130() throws Exception {
    ...
    try {
      ...
      client.expectGet(
          capsURL, new MockHttpResponse(getClass().getResource("caps130.xml"), "text/xml"));
      TestHttpClientProvider.bind(client, capsURL);
  ...
  public void testWMSLayer130crs84() throws Exception {
    ...
    try {
      ...
      URL capsURL = new URL(baseURL + "?service=WMS&request=GetCapabilities&version=1.3.0");
      client.expectGet(
          capsURL, new MockHttpResponse(getClass().getResource("caps130_crs84.xml"), "text/xml"));
      TestHttpClientProvider.bind(client, capsURL);
  ...
  public void testWMTSLayer100() throws Exception {
    ...
    try {
      ...
      client.expectGet(
          capsURL, new MockHttpResponse(getClass().getResource("nasa.getcapa.xml"), "text/xml"));
      TestHttpClientProvider.bind(client, capsURL);
