...
public class LayerGroupContainmentCacheTest {
  ...
  public void testAddRemoveNamed() throws Exception {
    ...
    assertThat(
        containerNamesForResource(MockData.LAKES), equalTo(set(CONTAINER_GROUP, NAMED_GROUP)));
  ...
  public void testAddRemoveNestedNamed() throws Exception {
    ...
    catalog.save(container);
    assertThat(
        containerNamesForResource(MockData.LAKES), equalTo(set(CONTAINER_GROUP, NESTED_NAMED)));
    assertThat(
