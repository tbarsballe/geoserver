...
public abstract class GeoServerTestSupport extends GeoServerAbstractTestSupport {
  ...
  /**
   * Adds the desired type and coverages to the data directory. This method adds all well known data
   * types, subclasses may add their extra ones or decide to avoid the standar ones and build a
   * custom list calling {@link MockData#addPropertiesType(QName, java.net.URL, java.net.URL)} and
   * {@link MockData#addCoverage(QName, InputStream, String)}
   *
   * @throws IOException
   */
