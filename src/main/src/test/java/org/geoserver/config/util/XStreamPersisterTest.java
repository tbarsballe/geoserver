...
public class XStreamPersisterTest {
  ...
  public void testVirtualTableMissingEscapeSql() throws Exception {
    ...
    FeatureTypeInfo ft =
        persister.load(
            getClass().getResourceAsStream("/org/geoserver/config/virtualtable_error.xml"),
  ...
  public void testVirtualTableMultipleGeoms() throws IOException {
    ...
    FeatureTypeInfo ft =
        persister.load(
            getClass()
                .getResourceAsStream("/org/geoserver/config/virtualtable_error_GEOS-7400.xml"),
            FeatureTypeInfo.class);
  ...
  /**
   * Test for GEOS-7444. Check GridGeometry is correctly unmarshaled when XML elements are provided
   * on an different order than the marshaling one
   *
   * @throws Exception
   */
  @Test
