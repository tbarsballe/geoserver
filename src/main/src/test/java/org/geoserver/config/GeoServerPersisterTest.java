...
public class GeoServerPersisterTest extends GeoServerSystemTestSupport {
  ...
  public void testChangeFeatureTypeStore() throws Exception {
    ...
    assertFalse(f1.exists());
    File f2 =
        new File(testData.getDataDirectoryRoot(), "workspaces/acme/barstore/foo/featuretype.xml");
    assertTrue(f2.exists());
  }
  ...
  public void testModifyWMTSLayer() throws Exception {
    ...
    File f =
        new File(
            testData.getDataDirectoryRoot(), "workspaces/acme/demowmts/foo_wmts/wmtslayer.xml");
    Document dom = dom(f);
  ...
  public void testModifyStyleChangeWorkspace2() throws Exception {
    ...
    assertTrue(
        new File(testData.getDataDirectoryRoot(), "workspaces/gs/styles/foostyle.xml").exists());
    assertTrue(
  ...
  public void testModifyStyleWithResourceChangeWorkspace() throws Exception {
    ...
    assertThat(
        ...
        fileExists());
    assertThat(
        new File(testData.getDataDirectoryRoot(), "workspaces/gs/styles/burg02.svg"), fileExists());
  }
  ...
  public void testModifyStyleWithResourcesInParentDirChangeWorkspace() throws Exception {
    ...
    assertThat(
        ...
        not(fileExists()));
    assertThat(
        new File(testData.getDataDirectoryRoot(), "workspaces/gs/burg03.svg"), not(fileExists()));
    assertThat(
        new File(testData.getDataDirectoryRoot(), "workspaces/gs/styles/burg02.svg"), fileExists());
  }
