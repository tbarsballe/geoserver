...
public class ServiceException extends org.geoserver.platform.ServiceException {
   ...
   *     small. Once we convert errors to print directly to the servlet output stream we can make it
   *     faster.
   */
  ...
  /**
   * Returns the mime type that should be exposed to the client when sending the exception message.
   *
