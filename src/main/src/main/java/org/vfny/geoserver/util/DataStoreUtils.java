...
public abstract class DataStoreUtils {
   ...
   * renaming wrapper so that feature type names are good ones from the wfs point of view (that is,
   * no ":" in the type names)
   *
   * @param params
  ...
  /**
   * Looks up the {@link DataAccess} using the given params, verbatim, and then eventually wraps it
   * into a renaming wrapper so that feature type names are good ones from the wfs point of view
   * (that is, no ":" in the type names)
   *
   * @param params
   */
