...
public abstract class Request {
   ...
   * element of a request. It now has a practical purpose in GeoServer, as a GetCapabilities request
   ...
   *
   * <p>Um, no. getType() is less clear. getRequest makes sense because this is directly modeled off
   * of the XML and KVP Requests that a wfs or wms makes, and they all contain an element called
   * Request.
   *
