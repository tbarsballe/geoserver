...
public final class Requests {
  ...
  */
   ...
   *
   * <p>Removed the hardcoded "http://" and replaced it with httpServletRequest.getScheme() because
  ...
  /**
   * This method gets the correct input stream for a URL. If the URL is a http/https connection, the
   * Accept-Encoding: gzip, deflate is added. It the paramter is added, the response is checked to
   * see if the response is encoded in gzip, deflate or plain bytes. The correct input stream
   * wrapper is then selected and returned.
   *
