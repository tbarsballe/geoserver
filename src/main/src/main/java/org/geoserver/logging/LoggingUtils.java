...
public class LoggingUtils {
  ...
  public static enum GeoToolsLoggingRedirection {
    ...
    /**
     * Returns the enum value corresponding to the name (using case insensitive comparison) or Log4j
   ...
   * uses the provided base location otherwise.
   *
   * <p>This method accepts a servlet context directly for cases where the logging location must be
   * known but the spring application context may not be initialized yet.
   */
