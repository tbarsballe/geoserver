...
public class LegacyConfigurationImporter {
  ...
  public void imprt(File dir) throws Exception {
    ...
    jai.setMemoryCapacity(
        (Double) value(global.get("JaiMemoryCapacity"), JAIInfoImpl.DEFAULT_MemoryCapacity));
    jai.setMemoryThreshold(
        (Double) value(global.get("JaiMemoryThreshold"), JAIInfoImpl.DEFAULT_MemoryThreshold));
    jai.setTileThreads(
