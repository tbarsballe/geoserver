...
public interface GeoServerPluginConfigurator {
   ...
   * This way we delegate the plugin to save its configuration since it is the only on who knows how
   * to do it better.
   *
   ...
   * This way we delegate the plugin to load its configuration since it is the only on who knows how
   * to do it better.
   *
   * @param resourceLoader
   * @throws IOException
