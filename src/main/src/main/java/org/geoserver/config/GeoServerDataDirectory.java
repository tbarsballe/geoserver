...
public class GeoServerDataDirectory {
  ...
  /**
   * Returns the root of the directory which contains spatial data files, if the directory does not
  ...
  /**
   * Returns a directory under the {@link #dataRoot()} directory, if the directory does not exist it
   * will be created.
   */
  ...
  /**
   * Returns the root of the directory which contains security configuration files, if the directory
   * does exist, null is returned.
   *
  ...
  /**
   * Returns the configuration file for the specified workspace, if the file does not exist null is
   * returned.
   *
  ...
  /**
   * Returns a supplementary configuration file for a workspace, if the file does not exist null is
   * returned.
   *
   * @deprecated As of GeoServer 2.6, replaced by {@link #get(WorkspaceInfo, String...)}
   */
  ...
  /**
   * Returns the configuration file for the specified namespace, if the file does not exist null is
   * returned.
   *
   * @deprecated As of GeoServer 2.6, replaced by {@link #get(WorkspaceInfo, String...)}
   */
  ...
  /**
   * Returns the directory in which global styles are persisted, if the directory does not exist it
   * will be created.
   *
   * @deprecated As of GeoServer 2.6, replaced by {@link #get(StyleInfo, String...)}
   */
  ...
  /**
   * Access to styles directory for provided workspace (or global styles directory if workspace not
   * provided).
   *
  ...
  /**
   * Returns the SLD file for the specified style, if the file does not exist a file object is still
   * returned.
   *
   * @deprecated As of GeoServer 2.6, replaced by {@link #style(StyleInfo, String...)}
   */
  ...
  /**
   * Retrieve a resource relative to the root of the data directory. An empty path will retrieve the
   * directory itself.
   *
  ...
  /**
   * Retrieve a resource in the the workspaces directory. An empty path will retrieve the directory
   * itself.
   *
   * @return A {@link Resource}
   */
   ...
   * namespace. An empty path will retrieve the directory itself. A null namespace will retrieve the
   * resouce in the global configuration directory.
   *
  ...
  /**
   * Retrieve a resource in the the configuration directory of a Store. An empty path will retrieve
  ...
  /**
   * Retrieve a resource in the the configuration directory of a Layer. An empty path will retrieve
   * the directory itself.
   *
   * @param li The store
   * @return A {@link Resource}
  ...
  /**
   * Retrieve a resource in the the styles directory of a workspace. An empty path will retrieve the
  ...
  /**
   * Retrieve the styled layer descriptor prepared for direct GeoTools use. All file references have
   * been made absolute.
   *
   * @param s The style
