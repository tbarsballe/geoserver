...
public enum ResourceErrorHandling {
  ...
  /**
   * When this mode is active, GeoServer will respond to errors by "rolling back" XML to the end of
   * the previous successfully encoded element, effectively omitting elements that correspond to
   * misconfigured layers in the GeoServer catalog.
   */
