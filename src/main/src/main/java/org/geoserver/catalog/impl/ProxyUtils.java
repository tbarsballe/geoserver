...
public class ProxyUtils {
  ...
  public static <T> T createProxy(T proxyObject, Class<T> clazz, InvocationHandler h) {
    ...
    try {
      if (constructor == null) {
        ...
        Class proxyClass =
            Proxy.getProxyClass(
                clazz.getClassLoader(), proxyInterfaces.toArray(new Class[proxyInterfaces.size()]));
   ...
   *
   * <p>This method handles two cases, the first is the case of a {@link WrappingProxy} in which the
