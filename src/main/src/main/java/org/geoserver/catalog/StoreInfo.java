...
public interface StoreInfo extends CatalogInfo {
   ...
   *
   * <p>The intent of this map is for services to associate data with a particular store which must
   * be persisted.
   *
  ...
  /**
   * @return Returns a resource with the specified name that is provided by the store, or <code>null
   *     </code> if no such resource exists.
