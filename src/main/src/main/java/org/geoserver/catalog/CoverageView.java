...
public class CoverageView implements Serializable {
   ...
   * the output band could be defined like this: Speed = SQRT(SELECTED_BAND_1^2 + SELECTED_BAND_2^2)
   */
  ...
  public static class CoverageBand implements Serializable {
     ...
     * band. Once we support different compositions, it will contain the maths... something like, as
     * an instance, speed = sqrt(u_component_of_the_wind@0 ^ 2 + v_component_of_the_wind@0^2).
     */
