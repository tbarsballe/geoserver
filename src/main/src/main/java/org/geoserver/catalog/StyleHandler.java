...
public abstract class StyleHandler {
   ...
   * @param resourceLocator Optional locator for resources (icons, etc...) referenced by the style,
   ...
   *
   * <p>For handlers that don't support an extended form of validation (like against an XML schema)
   * this implementation should at a minimum attempt to parse the input and return any parsing
   * errors.
   *
   * @param input The style input, see {@link #toReader(Object)} for accepted inputs.
   ...
   *
   * <p>This method should only be overriden by formats that support multiple versions. The default
