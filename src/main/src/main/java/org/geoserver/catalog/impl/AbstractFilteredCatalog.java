...
public abstract class AbstractFilteredCatalog extends AbstractDecorator<Catalog>
  ...
  /**
   * Given a {@link FeatureTypeInfo}, returns it back if the user can access it in write mode, makes
   * it read only if the user can access it in read only mode, returns null otherwise
   */
