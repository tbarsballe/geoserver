...
public class ReaderUtils {
   ...
   * getChildElements purpose.
   *
   * <p>Used to help with XML manipulations. Returns *all* child elements of the specified name. An
  ...
  public static boolean getBooleanAttribute(
      Element elem, String attName, boolean mandatory, boolean defaultValue) throws Exception {
   ...
   * @throws Exception If mandatory is set it to <code>true</code> and the child or attribute do not
   *     exist.
   */
