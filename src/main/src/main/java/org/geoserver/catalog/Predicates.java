...
public class Predicates {
   ...
   * "prop1[M].prop2.prop3[N]"}, where {@code prop1} and {@code prop3} are list or array properties,
   * {@code M} is the index of the {@code prop2} element to retrieve from {@code prop1}, and {@code
   * N} is the index of array or list property {@code prop3} to retrieve. Indexed access to
   * {{java.util.Set}} properties is <b>not</b> supported.
   *
   ...
   * creates a predicate that evaluates to {@code true} if any style in the set of styles of a layer
   * has the given id.
   *
   * <p>
   *
   * <p>If the evaluated object property value and the argument value are not of the same type, the
   ...
   * {@code true}.
   *
   * <p>The components are evaluated in order, and evaluation will be "short-circuited" as soon as a
