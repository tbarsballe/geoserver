...
public interface CatalogFacade {
   ...
   * {@link Catalog#fireModified(CatalogInfo, List, List, List)}. This is the responsibility of the
   * dao because it is best suited to knowing and tracking which attributes of the object have
   * changed.
   */
  ...
  /**
   * @return {@code true} if {@link #list} can sort objects of the given type by the given property
