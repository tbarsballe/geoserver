...
public interface Catalog extends CatalogInfo {
     ...
     * </p>
     *
     * @param ns    The prefix or uri to which the resource belongs, may be
     *              <code>null</code>.
     ...
     * </p>
     *
     * @param ns    The namespace to which the resource belongs, may be
     ...
     * </p>
     *
     * @param ns   The prefix or uri to which the feature type belongs, may
     ...
     * </p>
     *
     * @param ns   The namespace to which the feature type belongs, may
     *             be <code>null</code> to specify the default namespace.
     * @param name The name of the feature type.
     * @return The feature type matching the name, or <code>null</code> if no
     * such resource exists.
     ...
     * a matching virtual service.
     *
     * @param ns   The prefix or uri to which the coverage belongs, may be
     *             <code>null</code>.
     ...
     * </p>
     *
     * @param ns   The namespace to which the coverage belongs, may be
     *             <code>null</code>.
     * @param name The name of the coverage.
     * @return The coverage matching the name, or <code>null</code> if no such
     * resource exists.
