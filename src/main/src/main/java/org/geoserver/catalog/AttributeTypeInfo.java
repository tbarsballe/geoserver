...
public interface AttributeTypeInfo extends Serializable {
   ...
   * associate various bits of data with a particular attribute. An example might be its associated
   * xml or gml type.
   */
   ...
   *
   * <p>Note that this value is not persisted with other attributes, and could be <code>null</code>.
   */
  ...
  /**
   * The same as {@link #equals(Object)}, except doesn't compare {@link FeatureTypeInfo}s, to avoid
   * recursion.
   */
