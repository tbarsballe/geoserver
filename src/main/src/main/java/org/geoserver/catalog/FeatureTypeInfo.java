...
public interface FeatureTypeInfo extends ResourceInfo {
  ...
  /**
   * Sets the number of decimal places to use when encoding floating point numbers from data of this
   * feature type.
   */
  void setNumDecimals(int numDecimals);

  /**
   * Tolerance used to linearize this feature type, as an absolute value expressed in the geometries
   * own CRS
   */
   ...
   *
   * <p>The returned feature type is "wrapped" to take into account "metadata", such as reprojection
   * and name aliasing.
   */
