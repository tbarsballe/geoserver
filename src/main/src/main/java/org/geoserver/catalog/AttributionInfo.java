...
public interface AttributionInfo extends Info {
  ...
  /**
   * Get the mimetype field of the attribution, indicating the mimetype of the logo image pointed to
   * by the logoURL.
   *
  ...
  /**
   * Get the height field of the attribution, indicating the height of the logo image pointed to by
   * the logoURL.
   *
  ...
  /**
   * Set the mimetype field of the attribution, indicating the mimetype of the logo image pointed to
   * by the logoURL.
   *
  ...
  /**
   * Set the height field of the attribution, indicating the height of the logo image pointed to by
   * the logoURL.
   *
