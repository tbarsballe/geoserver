...
public class DigestAuthUtils {
   ...
   * removeCharacter</code>, and splits the element based on the <code>delimiter</code>. A <code>Map
   * </code> is then generated, with the left of the delimiter providing the key, and the right of
