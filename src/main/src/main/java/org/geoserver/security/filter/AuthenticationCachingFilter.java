...
public interface AuthenticationCachingFilter {
   ...
   *
   * <p>If there is an already existing HTTP Session, this method should return <code>null</code> If
   * the HTTP request attribute named
   * GeoServerSecurityContextPersistenceFilter.ALLOWSESSIONCREATION_ATTR is true, this method should
