...
public class DataAccessLimits extends AccessLimits {
   ...
   * if the remote server supports CQL filters and on feature info requests. For workspaces it will
   * be just INCLUDE or EXCLUDE to allow or deny access to the workspace
   */
