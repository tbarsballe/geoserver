...
public class SecuredObjects {
  ...
  /**
   * Given an object to secure and a wrapping policy, scans the extension points for a factory that
   * can do the proper wrapping and invokes it, or simply gives up and throws an {@link
