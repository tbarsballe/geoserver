...
public abstract class GeoServerSecurityProvider {
   ...
   *
   * <p>If the extension does not provide a role service this method should simply return <code>null
   * </code>.
   */
  ...
  /**
   * Returns a map containing the field names which should be encrypted. (backend store passwords as
   * an example)
   */
  ...
  /**
   * Startup hook - this will be executed after loading the security configuration, allowing plugins
   * to apply custom modifications to the security settings.
   */
