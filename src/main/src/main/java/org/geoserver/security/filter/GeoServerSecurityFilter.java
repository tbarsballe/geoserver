...
public abstract class GeoServerSecurityFilter extends AbstractGeoServerSecurityService
   ...
   *
   * <p>The {@link GeoServerExceptionTranslationFilter} may use the entry point in case of an {@link
  ...
  /**
   * Tries to authenticate from cache if a key can be derived and the {@link Authentication} object
