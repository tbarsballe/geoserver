...
public class FileBasedSecurityServiceConfig extends BaseSecurityNamedServiceConfig {
   ...
   *
   * <p>This property is typically used in environments (such as a cluster) in which the underlying
   * file may have been modified out of process.
   *
   * <p>A value of > 0 causes {@link FileWatcher} object to be created. A value of <= 0 disables any
   * checking of the underlying file.
   *
   * <p>Hint: the granularity of {@link File} last access time is often a second, values < 1000 may
