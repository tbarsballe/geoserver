...
public class SecurityUtils {
  ...
  /**
   * Spring Secruity 3.x drops the common base security exception class SpringSecurityException, now
   * the test is based on the package name
   *
   ...
   * String)} or {@link #toBytes(char[], Charset)} should be used instead. When not specified {@link
   * Charset#defaultCharset()} is used.
   */
   ...
   * String)} or {@link #toChars(byte[], Charset)} should be used instead. When not specified {@link
   * Charset#defaultCharset()} is used.
   */
