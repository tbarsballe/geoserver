...
public class CoverageAccessLimits extends DataAccessLimits {
   ...
   *     entire layer non readable (hides, challenges), otherwise it's added to the reader parameter
   *     should the reader have a filter among its params (mosaic does for example)
