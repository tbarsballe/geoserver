...
public interface SecurityNamedServiceConfig extends SecurityConfig {
   ...
   * time.
   *
   * <p>This method would typically be used to initialize properties not explicitly set by the user,
   * but that can be set based on other user initialized properties.
   */
  void initBeforeSave();
}
