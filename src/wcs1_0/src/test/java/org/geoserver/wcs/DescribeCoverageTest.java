...
public class DescribeCoverageTest extends WCSTestSupport {
  ...
  public void testDescribeUnknownCoverageKvp() throws Exception {
    Document dom =
        getAsDOM(BASEPATH + "?request=DescribeCoverage&service=WCS&version=1.0.0&coverage=plop");
    // print(dom);
  ...
  private void checkDemCoverageDescription(Document dom) throws Exception {
    ...
    assertXpathEvaluatesTo(
        getLayerId(TASMANIA_DEM), "/wcs:CoverageDescription/wcs:CoverageOffering/wcs:name", dom);
  ...
  public void testDescribeRotatedCoverage() throws Exception {
    ...
    assertEquals(1, dom.getElementsByTagName("wcs:CoverageOffering").getLength());
    assertXpathEvaluatesTo(
        getLayerId(ROTATED_CAD), "/wcs:CoverageDescription/wcs:CoverageOffering/wcs:name", dom);
  ...
  public void testDescribeImageCoverage() throws Exception {
    ...
    assertEquals(1, dom.getElementsByTagName("wcs:CoverageOffering").getLength());
    assertXpathEvaluatesTo(
        getLayerId(TASMANIA_BM), "/wcs:CoverageDescription/wcs:CoverageOffering/wcs:name", dom);
    // check there is no rotation
    Node gridOffsets =
        xpath
            .getMatchingNodes(
  ...
  public void testTimeCoverageList() throws Exception {
    ...
    assertXpathEvaluatesTo(
        "2008-10-31T00:00:00.000Z", "//gml:EnvelopeWithTimePeriod/gml:timePosition[1]", dom);
    assertXpathEvaluatesTo(
        "2008-11-01T00:00:00.000Z", "//gml:EnvelopeWithTimePeriod/gml:timePosition[2]", dom);
  ...
  public void testTimeCoverageContinousInterval() throws Exception {
    ...
    assertXpathEvaluatesTo(
        "2008-11-01T00:00:00.000Z", "//wcs:temporalDomain/wcs:timePeriod/wcs:endPosition", dom);
  }
  ...
  public void testTimeRangeCoverageList() throws Exception {
    ...
    assertXpathEvaluatesTo(
        "2008-10-31T00:00:00.000Z", "//gml:EnvelopeWithTimePeriod/gml:timePosition[1]", dom);
    assertXpathEvaluatesTo(
        "2008-11-07T00:00:00.000Z", "//gml:EnvelopeWithTimePeriod/gml:timePosition[2]", dom);
