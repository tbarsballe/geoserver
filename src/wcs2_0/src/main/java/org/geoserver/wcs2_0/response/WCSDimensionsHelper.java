...
public class WCSDimensionsHelper {
  ...
  /**
   * Base constructor which only deals with timeDimension. It is used by WCS-EO classes which deals
   * with up to timeDimensions
   *
   * @param timeDimension
   * @param reader
   * @param coverageId
  ...
  /**
   * Scan the metadataMap looking for resources related to {@link DimensionInfo} objects and return
   * a dimensions Map. Return an empty map if no dimensions are found.
   *
   * @param metadata
   */
