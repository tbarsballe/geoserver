...
public class RequestUtils {
   ...
   * negotiated version to be used for response according to the OWS 2.0 specification.
   *
   ...
   *     format)
   * @param acceptedList a list of accepted versions, eventually null or empty (in "x.y.z" or "x.y"
   *     format)
  ...
  public static GridCoverage2D readBestCoverage(
    ...
    if (length > 0) {
      ...
      coverage =
          (GridCoverage2D)
              reader.read(new GeneralParameterValue[] {readGGParam, readInterpolation});
    }
