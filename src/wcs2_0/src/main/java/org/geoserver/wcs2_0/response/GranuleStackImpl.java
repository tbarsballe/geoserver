...
public class GranuleStackImpl extends GridCoverage2D /*AbstractGridCoverage*/
  ...
  /**
   * Right now, all CoverageResponseDelegate work with GridCoverage2D. Therefore, in order to encode
   * a granuleStack we need to implement it as a GridCoverage2D. So we pass a Dummy GridCoverage2D
   * with dummy information to avoid constructor failures. The provided information will be ignored
   * anyway.
   *
   * <p>Once we move to extending AbstractGridCoverage instead of GridCoverage2D we may remove this
   * dummy class.
   */
    ...
    protected DummyGridCoverage2D(CharSequence name, CoordinateReferenceSystem crs)
      ...
      super(
          ...
          new GridGeometry2D(
              ...
              new GeneralEnvelope(
                  SAMPLE_GRID_ENVELOPE, PixelInCell.CELL_CENTER, SAMPLE_TRANSFORM, crs)),
          null,
          null,
          null,
          null);
