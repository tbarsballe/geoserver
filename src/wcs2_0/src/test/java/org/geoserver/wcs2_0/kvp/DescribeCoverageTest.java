...
public class DescribeCoverageTest extends WCSTestSupport {
  ...
  public void testAxisOrderUtm() throws Exception {
    ...
    assertXpathEvaluatesTo(
        "+1 +2", "//gml:coverageFunction/gml:GridFunction/gml:sequenceRule/@axisOrder", dom);
    assertXpathEvaluatesTo(
  ...
  public void testMultipleCoverages() throws Exception {
    ...
    assertXpathEvaluatesTo(
        "wcs__multiband", "//wcs:CoverageDescriptions/wcs:CoverageDescription[1]/@gml:id", dom);
    assertXpathEvaluatesTo(
        "9",
    ...
    assertXpathEvaluatesTo(
        ...
        dom);
    assertXpathEvaluatesTo(
        "wcs__BlueMarble", "//wcs:CoverageDescriptions/wcs:CoverageDescription[2]/@gml:id", dom);
    assertXpathEvaluatesTo(
        "3",
  ...
  public void testDescribeTimeList() throws Exception {
    ...
    assertXpathEvaluatesTo(
        "2", "count(//gmlcov:metadata/gmlcov:Extension/wcsgs:TimeDomain/gml:TimeInstant)", dom);
    assertXpathEvaluatesTo(
        "sf__watertemp_td_0",
  ...
  public void testDescribeTimeContinousInterval() throws Exception {
    setupRasterDimension(
        getLayerId(WATTEMP), ResourceInfo.TIME, DimensionPresentation.CONTINUOUS_INTERVAL, null);
    Document dom = getAsDOM(DESCRIBE_URL + "&coverageId=sf__watertemp");
    //        print(dom);
    ...
    // check that metadata contains a list of times
    assertXpathEvaluatesTo(
        "1", "count(//gmlcov:metadata/gmlcov:Extension/wcsgs:TimeDomain/gml:TimePeriod)", dom);
    assertXpathEvaluatesTo(
        "sf__watertemp_tp_0",
  ...
  public void testDescribeTimeRangeList() throws Exception {
    ...
    // check that metadata contains a list of times
    assertXpathEvaluatesTo(
        "2", "count(//gmlcov:metadata/gmlcov:Extension/wcsgs:TimeDomain/gml:TimePeriod)", dom);
    assertXpathEvaluatesTo(
        "sf__timeranges_td_0",
  ...
  public void testDescribeElevationDiscreteInterval() throws Exception {
    ...
    assertXpathEvaluatesTo(
        "1", "count(//gmlcov:metadata/gmlcov:Extension/wcsgs:ElevationDomain/wcsgs:Range)", dom);
    assertXpathEvaluatesTo(
        "20.0",
  ...
  public void testDescribeElevationRangeList() throws Exception {
    ...
    // check that metadata contains a list of elevations
    assertXpathEvaluatesTo(
        "2", "count(//gmlcov:metadata/gmlcov:Extension/wcsgs:ElevationDomain/wcsgs:Range)", dom);
    assertXpathEvaluatesTo(
        "20.0",
  ...
  public void testDescribeCustomDimensionsList() throws Exception {
    ...
    assertXpathEvaluatesTo(
        "WAVELENGTH", "//gmlcov:metadata/gmlcov:Extension/wcsgs:DimensionDomain[2]/@name", dom);
    assertXpathEvaluatesTo(
  ...
  private void checkWaterTempElevationEnvelope(Document dom) throws XpathException {
    ...
    assertXpathEvaluatesTo("1", "count(//gml:boundedBy/gml:EnvelopeWithTimePeriod)", dom);
    assertXpathEvaluatesTo(
        "Lat Long elevation", "//gml:boundedBy/gml:EnvelopeWithTimePeriod/@axisLabels", dom);
    assertXpathEvaluatesTo(
