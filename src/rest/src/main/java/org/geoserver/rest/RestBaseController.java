...
public abstract class RestBaseController implements RequestBodyAdvice {
   ...
   * XStreamMessageConverter)} and {@link RestHttpInputWrapper#configurePersister(XStreamPersister,
   * XStreamMessageConverter)} constructed by {@link #wrapObject(Object, Class)}, {@link
   * #wrapList(Collection, Class)}, and {@link #beforeBodyRead(HttpInputMessage, MethodParameter,
   * Type, Class)}
   *
