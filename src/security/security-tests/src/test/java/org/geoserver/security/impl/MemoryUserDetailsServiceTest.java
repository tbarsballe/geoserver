...
public class MemoryUserDetailsServiceTest extends AbstractUserDetailsServiceTest {
  ...
  public void testEncryption() throws Exception {
    ...
    Element roleElem =
        (Element) roleDoc.getDocumentElement().getElementsByTagName("toBeEncrypted").item(0);
    Element ugElem =
  ...
  public void testEncryption2() throws Exception {
    ...
    String plainprefix =
        getPlainTextPasswordEncoder().getPrefix() + GeoServerPasswordEncoder.PREFIX_DELIMTER;
    getSecurityManager().saveSecurityConfig(config);
    getSecurityManager().updateConfigurationFilesWithEncryptedFields();
