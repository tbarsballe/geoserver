...
public class GetCoverageTest extends AbstractGetCoverageTest {
  ...
  public void testInputLimits() throws Exception {
    try {
      ...
      assertEquals("ows:ExceptionReport", dom.getDocumentElement().getNodeName());
      String error =
          xpath.evaluate("/ows:ExceptionReport/ows:Exception/ows:ExceptionText/text()", dom);
  ...
  /**
   * This tests just ended up throwing an exception as the coverage being encoded was too large due
   * to a bug in the scales estimation
   */
  @Test
