...
public class DefaultServiceExceptionHandlerTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    Service service =
        new Service("hello", helloWorld, new Version("1.0.0"), Collections.singletonList("hello"));
  ...
  public void testHandleServiceExceptionEncoding() throws Exception {
    ...
    assertEquals(
        "round-tripped through character entities", message, exceptionText.getTextContent());
  }
