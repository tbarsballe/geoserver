...
public abstract class XmlRequestReader {
   ...
   *
   * <p>The <tt>request</tt> parameter may be <code>null</code>, so in this case the request reader
   * would be responsible for creating the request object, or throwing an exception if this is not
   * supported.
   *
