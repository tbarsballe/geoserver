...
public abstract class Response {
  ...
  /**
   * Constructor which specified the class this response is bound to, and a common name for the type
   * of response.
   *
   * @param binding The class of object the response serializes
  ...
  /**
   * Constructor which specified the class this response is bound to, and a set of common names for
   ...
   * SettingsInfo.getCharset() as well as the specific encoding requirements of the returned format.
   */
