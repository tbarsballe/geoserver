...
public class Request {
  ...
  /**
   * The Operation used to call the service code. Available only after dispatching is done, it will
   * give access to the current service object, and the parsed request
   */
