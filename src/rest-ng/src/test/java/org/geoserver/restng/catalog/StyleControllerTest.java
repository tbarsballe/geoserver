...
public class StyleControllerTest extends CatalogRESTTestSupport {
    ...
    public void testGetAllAsXML() throws Exception {
        Document dom = getAsDOM( "/rest/restng/styles.xml" );
    ...
    public void testGetAllAsHTML() throws Exception {
        Document dom = getAsDOM( "/rest/restng/styles.html");
        print(dom);
    ...
    public void testGetAllFromWorkspace() throws Exception {
        Document dom = getAsDOM( "/rest/restng/workspaces/gs/styles.xml" );
        ...
        dom = getAsDOM( "/rest/restng/workspaces/gs/styles.xml" );
        assertEquals("styles", dom.getDocumentElement().getNodeName());
    ...
    public void testGetAsXML() throws Exception {
        Document dom = getAsDOM( "/rest/restng/styles/Ponds.xml" );
    ...
    public void testGetAsJSON() throws Exception {
        JSON json = getAsJSON( "/rest/restng/styles/Ponds.json");
    ...
    public void testGetWrongStyle() throws Exception {
        ...
        // Request path
        String requestPath = "/rest/restng/styles/" + style + ".html";
        String requestPath2 = "/rest/restng/workspaces/" + ws + "/styles/" + style + ".html";
        // Exception path
    ...
    public void testGetAsSLD() throws Exception {
        Document dom = getAsDOM( "/rest/restng/styles/Ponds.sld");
    ...
    public void testGetFromWorkspace() throws Exception {
        MockHttpServletResponse resp = getAsServletResponse("/rest/restng/workspaces/gs/styles/foo.xml");
        assertEquals(404, resp.getStatus());

        addStyleToWorkspace("foo");

        resp = getAsServletResponse("/rest/restng/workspaces/gs/styles/foo.xml");
        assertEquals(200, resp.getStatus());

        Document dom = getAsDOM("/rest/restng/workspaces/gs/styles/foo.xml");
    ...
    public void testPostAsSLD() throws Exception {
        ...
        MockHttpServletResponse response =
            postAsServletResponse( "/rest/restng/styles", xml, SLDHandler.MIMETYPE_10);
    ...
    public void testPostAsSLDToWorkspace() throws Exception {
        ...
        MockHttpServletResponse response =
            postAsServletResponse( "/rest/restng/workspaces/gs/styles", xml, SLDHandler.MIMETYPE_10);
        assertEquals( 201, response.getStatus() );
        assertNotNull( response.getHeader( "Location") );
    ...
    public void testPostAsSLDWithName() throws Exception {
        ...
        MockHttpServletResponse response =
            postAsServletResponse( "/rest/restng/styles?name=bar", xml, SLDHandler.MIMETYPE_10);
        assertEquals( 201, response.getStatus() );
        assertNotNull( response.getHeader( "Location") );
    ...
    public void testPostToWorkspace() throws Exception {
        ...
        String xml =
            "<style>" +
                ...
                "</style>";
        MockHttpServletResponse response =
            postAsServletResponse("/rest/restng/workspaces/gs/styles", xml);
        assertEquals(201, response.getStatus());
    ...
    public void testPut() throws Exception {
        ...
        MockHttpServletResponse response =
            putAsServletResponse("/rest/restng/styles/Ponds", xml.getBytes(), "text/xml");
    ...
    public void testPutAsSLD() throws Exception {
        ...
        MockHttpServletResponse response =
            putAsServletResponse( "/rest/restng/styles/Ponds", xml, SLDHandler.MIMETYPE_10);
        assertEquals( 200, response.getStatus() );
    ...
    public void testDelete() throws Exception {
        String xml =
            "<style>" +
                ...
                "</style>";
        post( "/rest/restng/styles", xml, "text/xml");
        assertNotNull( catalog.getStyleByName( "dummy" ) );

        MockHttpServletResponse response =
            deleteAsServletResponse("/rest/restng/styles/dummy");
        assertEquals( 200, response.getStatus() );
    ...
    public void testDeleteWithLayerReference() throws Exception {
        ...
        MockHttpServletResponse response =
            deleteAsServletResponse("/rest/restng/styles/Ponds");
        assertEquals( 403, response.getStatus() );
    ...
    public void testDeleteWithLayerReferenceAndRecurse() throws Exception {
        ...
        MockHttpServletResponse response =
            deleteAsServletResponse("/rest/restng/styles/Ponds?recurse=true");
        assertEquals( 200, response.getStatus() );
    ...
    public void testDeleteWithoutPurge() throws Exception {
        ...
        response = deleteAsServletResponse("/rest/restng/styles/foo");
        assertEquals( 200, response.getStatus() );
    ...
    public void testDeleteWithPurge() throws Exception {
        ...
        response = deleteAsServletResponse("/rest/restng/styles/foo?purge=true");
        assertEquals( 200, response.getStatus() );
    ...
    public void testDeleteFromWorkspaceWithPurge() throws Exception {
        ...
        MockHttpServletResponse response = deleteAsServletResponse("/rest/restng/workspaces/gs/styles/foo?purge=true");
        assertEquals(200, response.getStatus());
    ...
    public void testPostByLayerWithDefault() throws Exception {
        ...
        String xml =
            "<style>" +
                ...
                "</style>";
        MockHttpServletResponse response =
            postAsServletResponse( "/rest/restng/layers/cite:BasicPolygons/styles?default=true", xml, "text/xml");
        assertEquals( 201, response.getStatus() );
    ...
    public void testPostAsPSL() throws Exception {
        ...
        MockHttpServletResponse response =
            postAsServletResponse( "/rest/restng/styles?name=foo", out.toString(), PropertyStyleHandler.MIMETYPE);
        assertEquals( 201, response.getStatus() );
        assertNotNull( response.getHeader( "Location") );
        assertTrue( response.getHeader("Location").endsWith( "/styles/foo" ) );
    ...
    public void testPostAsPSLRaw() throws Exception {
        ...
        MockHttpServletResponse response =
            postAsServletResponse( "/rest/restng/styles?name=foo&raw=true", out.toString(), PropertyStyleHandler.MIMETYPE);
        assertEquals( 201, response.getStatus() );
        assertNotNull( response.getHeader( "Location") );
        assertTrue( response.getHeader("Location").endsWith( "/styles/foo" ) );
    ...
    public void testPutAsPSL() throws Exception {
        ...
        MockHttpServletResponse response =
            putAsServletResponse( "/rest/restng/styles/foo", out.toString(), PropertyStyleHandler.MIMETYPE);
        assertEquals( 200, response.getStatus() );
    ...
    public void testPutAsPSLRaw() throws Exception {
        ...
        MockHttpServletResponse response =
            putAsServletResponse( "/rest/restng/styles/foo?raw=true", out.toString(), PropertyStyleHandler.MIMETYPE);
        assertEquals( 200, response.getStatus() );
    ...
    public void testPostAsSE() throws Exception {
        ...
        MockHttpServletResponse response =
            postAsServletResponse( "/rest/restng/styles?name=foo", xml, SLDHandler.MIMETYPE_11);
        assertEquals( 201, response.getStatus() );
        assertNotNull( response.getHeader( "Location") );
        assertTrue( response.getHeader("Location").endsWith( "/styles/foo" ) );
    ...
    public void testPostToWorkspaceSLDPackage() throws Exception {
        ...
        MockHttpServletResponse response =
            postAsServletResponse( "/rest/restng/workspaces/gs/styles", bytes, "application/zip");
        assertEquals( 201, response.getStatus() );
        assertNotNull(cat.getStyleByName("gs", "foo"));

        Document d = getAsDOM("/rest/restng/workspaces/gs/styles/foo.sld");
    ...
    public void testPostSLDPackage() throws Exception {
        ...
        MockHttpServletResponse response =
            postAsServletResponse( "/rest/restng/styles", bytes, "application/zip");
        assertEquals( 201, response.getStatus() );
        assertNotNull(cat.getStyleByName("foo"));

        Document d = getAsDOM("/rest/restng/styles/foo.sld");
