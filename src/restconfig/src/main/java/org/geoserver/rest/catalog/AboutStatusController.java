                  ...
                  new BeansWrapper() {
                    public TemplateModel wrap(Object object) throws TemplateModelException {
                      if (object instanceof ModuleStatus) {
                        ...
                        status
                            .getComponent()
                            .ifPresent(component -> hash.put("component", component));
                        status.getVersion().ifPresent(version -> hash.put("version", version));
                        // Make sure to escape the string, otherwise strange chars here will bork
                        // the XML parser later
                                ...
                                message -> {
                                  String noControlChars =
                                      message
                                          ...
                                          .replaceAll("\u0007", "BELL");
                                  String escaped =
                                      StringEscapeUtils.escapeXml(noControlChars)
                                          .replaceAll("\n", "<br/>");
