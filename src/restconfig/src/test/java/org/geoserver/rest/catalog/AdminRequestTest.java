...
public class AdminRequestTest extends CatalogRESTTestSupport {
  ...
  public void testWorkspaces() throws Exception {
    assertEquals(
        200, getAsServletResponse(RestBaseController.ROOT_PATH + "/workspaces.xml").getStatus());
    ...
    assertEquals(
        getCatalog().getWorkspaces().size(), dom.getElementsByTagName("workspace").getLength());
  ...
  public void testWorkspace() throws Exception {
    assertEquals(
        404, getAsServletResponse(RestBaseController.ROOT_PATH + "/workspaces/sf.xml").getStatus());
    assertEquals(
        404,
        getAsServletResponse(RestBaseController.ROOT_PATH + "/workspaces/cite.xml").getStatus());
