...
public class CoverageStoreControllerTest extends CatalogRESTTestSupport {
  ...
  public void testGetAllAsJSON() throws Exception {
    ...
    if (coveragestores instanceof JSONArray) {
      assertEquals(
          catalog.getCoverageStoresByWorkspace("wcs").size(), ((JSONArray) coveragestores).size());
    } else {
  ...
  public void testGetAsXML() throws Exception {
    Document dom =
        getAsDOM(RestBaseController.ROOT_PATH + "/workspaces/wcs/coveragestores/BlueMarble.xml");
    // print(dom);
  ...
  public void testGetAsHTML() throws Exception {
    ...
    try {
      Document dom =
          getAsDOM(RestBaseController.ROOT_PATH + "/workspaces/wcs/coveragestores/BlueMarble.html");
  ...
  public void testGetWrongCoverageStore() throws Exception {
    ...
    // Request path
    String requestPath =
        RestBaseController.ROOT_PATH + "/workspaces/" + ws + "/coveragestores/" + cs + ".html";
    // Exception path
  ...
  public void testPostAsXML() throws Exception {
    ...
    assertTrue(
        response.getHeader("Location").endsWith("/workspaces/wcs/coveragestores/newCoverageStore"));
  ...
  public void testRoundTripCoverageStoreXML() throws Exception {
    ...
    String xml =
        getAsString(RestBaseController.ROOT_PATH + "/workspaces/wcs/coveragestores/BlueMarble.xml");
    MockHttpServletResponse response =
  ...
  public void testGetAsJSON() throws Exception {
    JSON json =
        getAsJSON(RestBaseController.ROOT_PATH + "/workspaces/wcs/coveragestores/BlueMarble.json");
    // print(json);
  ...
  public void testRoundTripCoverageStoreJSON() throws Exception {
    ...
    String xml =
        getAsString(
            RestBaseController.ROOT_PATH + "/workspaces/wcs/coveragestores/BlueMarble.json");
    MockHttpServletResponse response =
        putAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/wcs/coveragestores/BlueMarble",
            xml,
  ...
  public void testPutEmptyAndHarvest() throws Exception {
    ...
    fout = new FileOutputStream(f);
    IOUtils.copy(
        getClass().getResourceAsStream("test-data/NCOM_wattemp_020_20081031T0000000_12.tiff"),
        fout);
    fout.flush();
    fout.close();
