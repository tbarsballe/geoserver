...
public class WMTSLayerTest extends CatalogRESTTestSupport {
  ...
  public void testGetAllByWorkspace() throws Exception {
    ...
    assertEquals(
        catalog
            .getResourcesByNamespace(catalog.getNamespaceByPrefix("sf"), WMTSLayerInfo.class)
            .size(),
  ...
  public void testPostAsXML() throws Exception {
    ...
    assertThat(
        catalog.getResourceByName("sf", ANOTHER_LOCAL_NAME, WMTSLayerInfo.class), nullValue());
    ...
    assertThat(
        ...
        hasHeader(
            "Location",
            Matchers.endsWith("/workspaces/sf/wmtsstores/demo/layers/" + ANOTHER_LOCAL_NAME)));
  ...
  public void testPostAsXMLNoWorkspace() throws Exception {
    ...
    MockHttpServletResponse response =
        postAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmtslayers/", xml, "text/xml");
    ...
    assertThat(
        response,
        hasHeader(
            "Location", Matchers.endsWith("/workspaces/sf/wmtslayers/" + ANOTHER_LOCAL_NAME)));
  ...
  public void testGetAsXML() throws Exception {
    MockHttpServletResponse response =
        getAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmtslayers/" + LAYER_NAME + ".xml");
    assertThat(response, hasStatus(HttpStatus.OK));
    Document dom = dom(istream(response));
  ...
  public void testGetAsJSON() throws Exception {
    JSON json =
        getAsJSON(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmtslayers/" + LAYER_NAME + ".json");
  ...
  public void testPutNonExistant() throws Exception {
    ...
    MockHttpServletResponse response =
        putAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmtsstores/demo/layers/bugsites",
            xml,
            "text/xml");
