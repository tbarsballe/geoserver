...
public class WMSLayerTest extends CatalogRESTTestSupport {
  ...
  public void testGetAllByWorkspace() throws Exception {
    ...
    assertEquals(
        catalog
            .getResourcesByNamespace(catalog.getNamespaceByPrefix("sf"), WMSLayerInfo.class)
            .size(),
  ...
  public void testGetAllByWMSStore() throws Exception {
    MockHttpServletResponse response =
        getAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmsstores/demo/wmslayers.xml");
    assertThat(response, hasStatus(HttpStatus.OK));
    Document dom = dom(istream(response));
  ...
  public void testPostAsXML() throws Exception {
    ...
    assertThat(
        response,
        hasHeader(
            "Location", Matchers.endsWith("/workspaces/sf/wmsstores/demo/wmslayers/bugsites")));
  ...
  public void testPostAsXMLNoWorkspace() throws Exception {
    ...
    assertThat(
        response, hasHeader("Location", Matchers.endsWith("/workspaces/sf/wmslayers/bugsites")));
  ...
  public void testPut() throws Exception {
    ...
    Document dom =
        getAsDOM(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmsstores/demo/wmslayers/states.xml");
  ...
  public void testPutNonExistant() throws Exception {
    ...
    MockHttpServletResponse response =
        putAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmsstores/demo/wmslayers/bugsites",
            xml,
            "text/xml");
