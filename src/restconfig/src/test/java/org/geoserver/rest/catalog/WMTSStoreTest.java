...
public class WMTSStoreTest extends CatalogRESTTestSupport {
  ...
  public void testGetWrongWMTSStore() throws Exception {
    ...
    // Request path
    String requestPath =
        RestBaseController.ROOT_PATH + "/workspaces/" + ws + "/wmtsstores/" + wmts + ".html";
    // Exception path
  ...
  public void testPostAsXML() throws Exception {
    ...
    MockHttpServletResponse response =
        postAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmtsstores", xml, "text/xml");
  ...
  public void testPostAsJSON() throws Exception {
    ...
    MockHttpServletResponse response =
        postAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmtsstores", json, "text/json");
  ...
  public void testPostToResource() throws Exception {
    ...
    MockHttpServletResponse response =
        postAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmtsstores/demo", xml, "text/xml");
  ...
  public void testDeleteNonExistant() throws Exception {
    assertEquals(
        ...
        deleteAsServletResponse(
                RestBaseController.ROOT_PATH + "/workspaces/sf/datastores/nonExistant")
            .getStatus());
  }
  ...
  public void testDelete() throws Exception {
    ...
    assertEquals(
        200,
        deleteAsServletResponse(
                RestBaseController.ROOT_PATH + "/workspaces/sf/wmtsstores/newWMTSStore")
            .getStatus());
