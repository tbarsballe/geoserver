...
public class WMSStoreTest extends CatalogRESTTestSupport {
  ...
  public void testPostAsJSON() throws Exception {
    ...
    MockHttpServletResponse response =
        postAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmsstores", json, "text/json");
  ...
  public void testPostToResource() throws Exception {
    ...
    MockHttpServletResponse response =
        postAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/sf/wmsstores/demo", xml, "text/xml");
  ...
  public void testDelete() throws Exception {
    ...
    assertEquals(
        200,
        deleteAsServletResponse(
                RestBaseController.ROOT_PATH + "/workspaces/sf/wmsstores/newWMSStore")
            .getStatus());
