...
public class LayerGroupControllerTest extends CatalogRESTTestSupport {
  ...
  public void testGetAllAsXML() throws Exception {
    ...
    assertEquals(
        catalog.getLayerGroups().size(), dom.getElementsByTagName("layerGroup").getLength());
  }
  ...
  public void testRoundTripXML() throws Exception {
    ...
    MockHttpServletResponse response =
        putAsServletResponse(
            RestBaseController.ROOT_PATH + "/layergroups/sfLayerGroup", xml, "text/xml");
  ...
  public void testWorkspaceRoundTripJSON() throws Exception {
    ...
    String json =
        getAsString(
            RestBaseController.ROOT_PATH + "/workspaces/sf/layergroups/workspaceLayerGroup.json");
    MockHttpServletResponse response =
        putAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/sf/layergroups/workspaceLayerGroup",
            json,
  ...
  public void testPutToWorkspace() throws Exception {
    ...
    assertEquals(200, response.getStatus());
    assertEquals(
        "line", cat.getLayerGroupByName("sf", "workspaceLayerGroup").getStyles().get(0).getName());
  }
  ...
  public void testDelete() throws Exception {
    ...
    assertEquals(200, response.getStatus());
    response =
        deleteAsServletResponse(RestBaseController.ROOT_PATH + "/layergroups/citeLayerGroup");
    assertEquals(200, response.getStatus());
