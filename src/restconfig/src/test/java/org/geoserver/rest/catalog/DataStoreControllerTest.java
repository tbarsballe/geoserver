...
public class DataStoreControllerTest extends CatalogRESTTestSupport {
  ...
  public void testDeleteNonExistant() throws Exception {
    assertEquals(
        404,
        deleteAsServletResponse(ROOT_PATH + "/workspaces/sf/datastores/nonExistant").getStatus());
  }
  ...
  public void testDelete() throws Exception {
    ...
    assertEquals(
        200,
        deleteAsServletResponse(ROOT_PATH + "/workspaces/sf/datastores/newDataStore").getStatus());
  ...
  public void testDeleteNonEmptyForbidden() throws Exception {
    assertEquals(
        403, deleteAsServletResponse(ROOT_PATH + "/workspaces/sf/datastores/sf").getStatus());
  }
