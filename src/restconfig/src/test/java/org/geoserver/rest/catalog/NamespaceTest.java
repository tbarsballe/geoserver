...
public class NamespaceTest extends CatalogRESTTestSupport {
  ...
  public void testGetAllAsXML() throws Exception {
    ...
    assertEquals(catalog.getNamespaces().size(), dom.getElementsByTagName("namespace").getLength());
  }
  ...
  public void testPutAllUnauthorized() throws Exception {
    assertEquals(
        405, putAsServletResponse(RestBaseController.ROOT_PATH + "/namespaces").getStatus());
  }

  @Test
  public void testDeleteAllUnauthorized() throws Exception {
    assertEquals(
        405, deleteAsServletResponse(RestBaseController.ROOT_PATH + "/namespaces").getStatus());
  }
  ...
  public void testRoundTripXMLSerialization() throws Exception {
    removeNamespace("ian");
    String xml =
        "<namespace>" + "<prefix>ian</prefix>" + "<uri>http://ian.com</uri>" + "</namespace>";
  ...
  public void testGetNonExistant() throws Exception {
    assertEquals(
        404, getAsServletResponse(RestBaseController.ROOT_PATH + "/namespaces/none").getStatus());
  }

  @Test
  public void testPostAsXML() throws Exception {
    String xml =
        "<namespace>" + "<prefix>foo</prefix>" + "<uri>http://foo.com</uri>" + "</namespace>";
    MockHttpServletResponse response =
        postAsServletResponse(RestBaseController.ROOT_PATH + "/namespaces", xml, "text/xml");
    assertEquals(201, response.getStatus());
    assertNotNull(response.getHeader("Location"));
  ...
  public void testDelete() throws Exception {
    ...
    assertEquals(
        200, deleteAsServletResponse(RestBaseController.ROOT_PATH + "/namespaces/foo").getStatus());
    assertEquals(
        404,
        getAsServletResponse(RestBaseController.ROOT_PATH + "/namespaces/foo.xml").getStatus());
  ...
  public void testDeleteNonEmpty() throws Exception {
    assertEquals(
        401, deleteAsServletResponse(RestBaseController.ROOT_PATH + "/namespaces/sf").getStatus());
  }
