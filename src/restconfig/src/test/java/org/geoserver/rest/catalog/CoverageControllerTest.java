...
public class CoverageControllerTest extends CatalogRESTTestSupport {
  ...
  public void testGetAllByWorkspaceJSON() throws Exception {
    JSONObject json =
        (JSONObject) getAsJSON(RestBaseController.ROOT_PATH + "/workspaces/wcs/coverages.json");
  ...
  public void testPutWithCalculation() throws Exception {
    String path =
        RestBaseController.ROOT_PATH + "/workspaces/wcs/coveragestores/DEM/coverages/DEM.xml";
  ...
  public void testCoverageWrapping() throws Exception {
    ...
    MockHttpServletResponse response =
        putAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/wcs/coveragestores/DEM/coverages/DEM",
            xml,
            "text/xml");
    assertEquals(200, response.getStatus());
    ...
    response =
        putAsServletResponse(
            RestBaseController.ROOT_PATH + "/workspaces/wcs/coveragestores/DEM/coverages/tazdem",
            xml,
            "text/xml");
    assertEquals(200, response.getStatus());
