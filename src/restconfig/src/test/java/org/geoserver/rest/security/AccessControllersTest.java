...
public class AccessControllersTest extends SecurityRESTTestSupport {
  ...
  void checkXMLResponse(Document dom, String[][] rules) throws XpathException {
    ...
    assertEquals(
        rules.length,
        dom.getDocumentElement().getElementsByTagName(RuleMapXMLConverter.RULEELEMENT).getLength());
    String pattern =
        "/"
  ...
  public void testXMLPost() throws Exception {
    ...
    assertEquals(
        409, postAsServletResponse(DATA_URI_XML, createXMLBody(toBeAdded), "text/xml").getStatus());
    ...
    assertEquals(
        200,
        postAsServletResponse(DATA_URI_XML, createXMLBody(toBeAdded2), "text/xml").getStatus());
    ...
    assertEquals(
        200,
        postAsServletResponse(SERVICE_URI_XML, createXMLBody(toBeAdded2), "text/xml").getStatus());
    ...
    assertEquals(
        409, postAsServletResponse(REST_URI_XML, createXMLBody(toBeAdded), "text/xml").getStatus());
    ...
    assertEquals(
        200,
        postAsServletResponse(REST_URI_XML, createXMLBody(toBeAdded2), "text/xml").getStatus());
  ...
  public void testJSONPost() throws Exception {
    ...
    assertEquals(
        409,
        postAsServletResponse(DATA_URI_JSON, createJSONBody(toBeAdded), "text/json").getStatus());
    ...
    assertEquals(
        200,
        postAsServletResponse(DATA_URI_JSON, createJSONBody(toBeAdded2), "text/json").getStatus());
    ...
    assertEquals(
        409,
        postAsServletResponse(REST_URI_JSON, createJSONBody(toBeAdded), "text/json").getStatus());
    ...
    assertEquals(
        200,
        postAsServletResponse(REST_URI_JSON, createJSONBody(toBeAdded2), "text/json").getStatus());
  ...
  public void testJSONPut() throws Exception {
    ...
    assertEquals(
        409,
        putAsServletResponse(DATA_URI_JSON, createJSONBody(toBeModified), "text/json").getStatus());
    ...
    rules = getDefaultServiceRules();
    toBeModified2 =
        new String[][] {{"ws.*", TEST_ROLE1}, {"ws2.GetFeature", TEST_ROLELIST}}; // conflict
    assertEquals(
        409,
    ...
    assertEquals(
        409,
        putAsServletResponse(REST_URI_JSON, createJSONBody(toBeModified), "text/json").getStatus());
  ...
  public void testXMLPut() throws Exception {
    ...
    assertEquals(
        409,
        putAsServletResponse(DATA_URI_XML, createXMLBody(toBeModified), "text/xml").getStatus());
    ...
    assertEquals(
        200,
        putAsServletResponse(DATA_URI_XML, createXMLBody(toBeModified2), "text/xml").getStatus());
    ...
    assertEquals(
        409,
        putAsServletResponse(REST_URI_XML, createXMLBody(toBeModified), "text/xml").getStatus());
    ...
    assertEquals(
        200,
        putAsServletResponse(REST_URI_XML, createXMLBody(toBeModified2), "text/xml").getStatus());
  ...
  public void testCatalogMode() throws Exception {
    ...
    assertEquals(
        ...
        putAsServletResponse(
                CATALOG_URI_JSON, MessageFormat.format(jsonTemplate, "ABC"), "text/json")
            .getStatus());
    assertEquals(
        422,
  ...
  public void testInvalidRules() throws Exception {
    ...
    assertEquals(
        422, postAsServletResponse(DATA_URI_XML, createXMLBody(toBeAdded), "text/xml").getStatus());
    // check if nothing changed
    Document dom = getAsDOM(DATA_URI_XML);
    checkXMLResponse(dom, rules);
    ...
    assertEquals(
        422,
        postAsServletResponse(SERVICE_URI_XML, createXMLBody(toBeAdded), "text/xml").getStatus());
    // check if nothing changed
    dom = getAsDOM(SERVICE_URI_XML);
    checkXMLResponse(dom, rules);
    ...
    toBeAdded = new String[][] {rules[0], {"/myworkspace/**!!!GET", TEST_ROLELIST}}; // conflict
    assertEquals(
        422, postAsServletResponse(REST_URI_XML, createXMLBody(toBeAdded), "text/xml").getStatus());
  ...
  public void testNotAuthorized() throws Exception {
    ...
    assertEquals(
        403, putAsServletResponse(DATA_URI_XML, createXMLBody(dataRules), "text/xml").getStatus());
    assertEquals(
        403,
        putAsServletResponse(DATA_URI_JSON, createJSONBody(dataRules), "text/json").getStatus());
    assertEquals(
        403,
        putAsServletResponse(SERVICE_URI_XML, createXMLBody(serviceRules), "text/xml").getStatus());
    assertEquals(
        403,
        putAsServletResponse(SERVICE_URI_JSON, createJSONBody(serviceRules), "text/json")
            .getStatus());
    assertEquals(
        403, putAsServletResponse(REST_URI_XML, createXMLBody(restRules), "text/xml").getStatus());
    assertEquals(
        403,
        putAsServletResponse(REST_URI_JSON, createJSONBody(restRules), "text/json").getStatus());

    assertEquals(
        403, postAsServletResponse(DATA_URI_XML, createXMLBody(dataRules), "text/xml").getStatus());
    assertEquals(
        403,
        postAsServletResponse(DATA_URI_JSON, createJSONBody(dataRules), "text/json").getStatus());
    assertEquals(
        403,
    ...
    assertEquals(
        ...
        postAsServletResponse(SERVICE_URI_JSON, createJSONBody(serviceRules), "text/json")
            .getStatus());
    assertEquals(
        403, postAsServletResponse(REST_URI_XML, createXMLBody(restRules), "text/xml").getStatus());
    assertEquals(
        403,
        postAsServletResponse(REST_URI_JSON, createJSONBody(restRules), "text/json").getStatus());
