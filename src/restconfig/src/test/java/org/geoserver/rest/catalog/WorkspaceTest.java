...
public class WorkspaceTest extends CatalogRESTTestSupport {
  ...
  public void testPutAllUnauthorized() throws Exception {
    assertEquals(
        405, putAsServletResponse(RestBaseController.ROOT_PATH + "/workspaces").getStatus());
  }

  @Test
  public void testDeleteAllUnauthorized() throws Exception {
    assertEquals(
        405, deleteAsServletResponse(RestBaseController.ROOT_PATH + "/workspaces").getStatus());
  }
  ...
  public void testGetNonExistant() throws Exception {
    assertEquals(
        404, getAsServletResponse(RestBaseController.ROOT_PATH + "/workspaces/none").getStatus());
  }
  ...
  public void testDelete() throws Exception {
    ...
    assertEquals(
        200, deleteAsServletResponse(RestBaseController.ROOT_PATH + "/workspaces/foo").getStatus());
    assertEquals(
        404,
        getAsServletResponse(RestBaseController.ROOT_PATH + "/workspaces/foo.xml").getStatus());
  }
  ...
  public void testDeleteNonEmptyForbidden() throws Exception {
    ...
    assertEquals(
        403, deleteAsServletResponse(RestBaseController.ROOT_PATH + "/workspaces/sf").getStatus());
  }
  ...
  public void testDeleteDefault() throws Exception {
    assertEquals(
        200,
        deleteAsServletResponse(RestBaseController.ROOT_PATH + "/workspaces/default").getStatus());
  }
  ...
  public void testRoundTripXMLSerialization() throws Exception {
    ...
    dom =
        getAsDOM(RestBaseController.ROOT_PATH + "/workspaces/" + SystemTestData.SF_PREFIX + ".xml");
    ...
    response =
        postAsServletResponse(RestBaseController.ROOT_PATH + "/workspaces", output, "text/xml");
    assertEquals(201, response.getStatus());
    assertNotNull(response.getHeader("Location"));
  ...
  public void testRoundTripJSONSerialization() throws Exception {
    ...
    jsonObj =
        getAsJSON(
            RestBaseController.ROOT_PATH + "/workspaces/" + SystemTestData.SF_PREFIX + ".json");
