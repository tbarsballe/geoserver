...
public class FeatureTypeControllerTest extends CatalogRESTTestSupport {
  ...
  public void testGetAllAvailable() throws Exception {
    ...
    Document dom =
        getAsDOM(BASEPATH + "/workspaces/gs/datastores/pds/featuretypes.xml?list=available");
  ...
  public void testGetAllAvailableWithGeometryOnly() throws Exception {
    ...
    Document dom =
        getAsDOM(BASEPATH + "/workspaces/gs/datastores/ngpds/featuretypes.xml?list=available");
    assertXpathEvaluatesTo("2", "count(//featureTypeName)", dom);

    dom =
        getAsDOM(
            BASEPATH + "/workspaces/gs/datastores/ngpds/featuretypes.xml?list=available_with_geom");
    assertXpathEvaluatesTo("0", "count(//featureTypeName)", dom);
  }

  /**
   * Test that a list of all feature types for a data source are returned when "list=all", including
   * both configured and unconfigured ones.
   */
  @Test
  ...
  public void testPutAllUnauthorized() throws Exception {
    assertEquals(
        405,
        putAsServletResponse(BASEPATH + "/workspaces/sf/datastores/sf/featuretypes").getStatus());
  }
  ...
  public void testGetWrongFeatureType() throws Exception {
    ...
    String requestPath2 =
        BASEPATH + "/workspaces/" + ws + "/datastores/" + ds + "/featuretypes/" + ft + ".html";
    // Exception path
  ...
  public void testPut() throws Exception {
    ...
    Document dom =
        getAsDOM(BASEPATH + "/workspaces/sf/datastores/sf/featuretypes/PrimitiveGeoFeature.xml");
  ...
  public void testPutWithoutStore() throws Exception {
    ...
    MockHttpServletResponse response =
        putAsServletResponse(
            BASEPATH + "/workspaces/sf/featuretypes/PrimitiveGeoFeature", xml, "text/xml");
    assertEquals(200, response.getStatus());
  ...
  public void testRoundTripFeatureTypeXML() throws Exception {
    ...
    String xml =
        getAsString(BASEPATH + "/workspaces/sf/datastores/sf/featuretypes/PrimitiveGeoFeature.xml");
    MockHttpServletResponse response =
        putAsServletResponse(
            BASEPATH + "/workspaces/sf/datastores/sf/featuretypes/PrimitiveGeoFeature",
            xml,
  ...
  public static void assertContains(String message, String contains) {
    assertTrue(
        "Expected \"" + message + "\" to contain \"" + contains + "\"", message.contains(contains));
  }
}
