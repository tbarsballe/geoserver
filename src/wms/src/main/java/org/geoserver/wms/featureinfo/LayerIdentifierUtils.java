...
public final class LayerIdentifierUtils {
  ...
  /**
   * Helper method that tries to find feature collection CRS. First we try to use schema defined CRS
   * then we try to find a common CRS among simple features default geometries. If this is not a
   * simple feature collection or if no common CRS can be found (i.e. we have geometries with
