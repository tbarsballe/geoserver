...
class PALFileLoader {
   ...
   * for the colormap we area going to create. If this happens we might get very bad behaviour. Note
   * also that if we set this parameter to -1 we'll get an opaque {@link IndexColorModel}.
   *
