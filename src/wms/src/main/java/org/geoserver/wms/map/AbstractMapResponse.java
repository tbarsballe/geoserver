...
public abstract class AbstractMapResponse extends Response {
   ...
   * image/png;param1=value1}. This default canHandle implementation performs and exact match check
   * against the requested and supported format names. Subclasses may feel free to override if
   * needed.
   *
