...
public abstract class WMSRequest {
  ...
  /**
   * Tells whether the originating request used HTTP GET method or not; may be useful, for example,
   * to determine if client can do HTTP caching and then set the corresponding response headers.
   *
