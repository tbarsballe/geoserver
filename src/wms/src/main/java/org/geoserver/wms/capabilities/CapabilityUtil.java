...
public final class CapabilityUtil {
  ...
  public static NumberRange<Double> searchMinMaxScaleDenominator(Set<StyleInfo> styles)
      throws IOException {
    // searches the maximum and minimum denominator in the style's rules that are contained in the
    // style set.
  ...
  public static Double computeScaleHint(final Double scaleDenominator) {
    ...
    // According to OGC SLD 1.0 specification: The "standardized rendering pixel size" is defined to
    // be 0.28mm × 0.28mm (millimeters).
