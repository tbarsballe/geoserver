...
public class FeatureTemplate {
  ...
  private void execute(
      Object feature, SimpleFeatureType featureType, Writer writer, String template, Class lookup)
      throws IOException {
    Template t = null;
  ...
  /**
   * Returns the template for the specified feature type. Looking up templates is pretty expensive,
   * so we cache templates by feture type and template.
   */
