...
public abstract class Cell {
  ...
  public static class SingleColorMapEntryLegendBuilder extends ColorMapEntryLegendBuilder {
    ...
    public SingleColorMapEntryLegendBuilder(
      ...
      super.add(
          new ColorManager.SimpleColorManager(color, opacity, requestedDimension, borderColor));
  ...
  public static class ClassesEntryLegendBuilder extends ColorMapEntryLegendBuilder {
    ...
    public ClassesEntryLegendBuilder(
      ...
      String label = currentCME.getLabel();
      double quantity1 =
          leftEdge ? LegendUtils.getQuantity(currentCME) : LegendUtils.getQuantity(previousCME);
  ...
  public static class TextManager extends Cell {
    ...
    public Dimension getPreferredDimension(final Graphics2D graphics) {
      ...
      final int labelHeight =
          (int) Math.ceil(graphics.getFontMetrics().getStringBounds(text, graphics).getHeight());
      final int labelWidth =
          (int) Math.ceil(graphics.getFontMetrics().getStringBounds(text, graphics).getWidth());
  ...
  /**
   * This class mimics a simple color cell for the final {@link ColorMap} legend representation. It
   * is responsible for for drawing colors for a {@link ColorMapEntry}.
   *
   * @author Simone Giannecchini, GeoSolutions SAS
   */
      ...
      public static class GradientColorManager extends SimpleColorManager {
        ...
        public Dimension getPreferredDimension(Graphics2D graphics) {
          ...
          return new Dimension(
              requestedDimension.width, (int) (1.5 * requestedDimension.height + 0.5));
        }
