...
public abstract class AbstractDefaultValueSelectionStrategy
  ...
  @Override
  /**
   * Formats the dimension default value for the capabilities file as ISO 8601 DateTime for TIME and
   * as a number for ELEVATION. Assumes that getDefaultValue returns a single value, classes
