...
public class XML311FeatureInfoOutputFormat extends GML3FeatureInfoOutputFormat {
  ...
  /**
   * The MIME type of the format this response produces: <code>"text/xml; subtype=gml/3.1.1"</code>.
   * This is an alternative format for GML3: <code>"application/vnd.ogc.gml/3.1.1"</code>.
   */
