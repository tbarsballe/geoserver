...
public abstract class GetFeatureInfoOutputFormat {
  ...
  /**
   * Returns the charset for this outputFormat. The default implementation returns <code>null</code>
   * , in this case no encoding should be set. Subclasses returning text documents (CSV,HTML,JSON)
   * should override taking into account SettingsInfo.getCharset() as well as the specific encoding
