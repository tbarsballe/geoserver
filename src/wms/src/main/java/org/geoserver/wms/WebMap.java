...
public abstract class WebMap {
   ...
   * happens at the end of a {@link Response#write} operation, and is meant to free any resource the
   * map implementation might be holding, specially if it contains a refrerence to {@link
   ...
   *
   * <p>The file name will be followed by the extension provided, for example, to generate layer.pdf
