...
public class ImageUtils {
   ...
   * @param paletteInverter an {@link IndexColorModel} if the image is to be indexed, or <code>null
   *     </code> otherwise.
   * @return an image of size <code>width x height</code> appropriate for the given color model, if
   *     any, and to be used as a transparent image or not depending on the <code>transparent</code>
   *     parameter.
   */
   ...
   * @param extraHints an optional map of extra rendering hints to apply to the {@link Graphics2D},
   *     other than {@link RenderingHints#KEY_ANTIALIASING}.
