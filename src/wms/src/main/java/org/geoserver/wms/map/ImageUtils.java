...
public class ImageUtils {
     ...
     * @param paletteInverter an {@link IndexColorModel} if the image is to be indexed, or
     ...
     * @param bgColor       the background color to fill the graphics with if its not
     *                      transparent.
     * @param preparedImage the image for which to create the graphics.
     * @param extraHints    an optional map of extra rendering hints to apply to the
