...
public class DescribeLayerTransformer extends TransformerBase {
   ...
   * the DOCTYPE token pointing to the DescribeLayer DTD on this server instance.
   *
  ...
  private class DescribeLayerTranslator extends TranslatorSupport {
    ...
    /**
     * As currently GeoServer does not have support for nested layers, this method declares a <code>
     * LayerDescription</code> element for each featuretype requested.
     *
     * @param req
     */
