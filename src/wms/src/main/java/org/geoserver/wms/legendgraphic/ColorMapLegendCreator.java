...
public class ColorMapLegendCreator {
  ...
  public static class Builder {
    ...
    /**
     * Adds a {@link ColorMapEntry} element to this builder so that it can take it into account for
     * building the legend.
     *
     * @param cEntry a {@link ColorMapEntry} element for this builder so that it can take it into
     *     account for building the legend. It must be not <code>null</code>.
     */
    public ColorMapEntryLegendBuilder addColorMapEntry(final ColorMapEntry cEntry) {
      ...
      //
      //
      // NOTE for using the unit and digits values, the field "alternativeColorMapEntryBuilder" must
      // be set to
    ...
    /**
     * Sets the {@link ColorMapType} for this legend builder in order to instruct it on how to build
     * the legend.
     *
     * @param colorMapType the {@link ColorMapType} for this legend builder in order to instruct it
     *     on how to build the legend.
     */
