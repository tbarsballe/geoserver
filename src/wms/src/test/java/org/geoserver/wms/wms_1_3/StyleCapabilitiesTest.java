...
public class StyleCapabilitiesTest extends WMSTestSupport {
  ...
  private static final QName LAYER_WITHOUT_STYLE_DESCRIPTION =
      new QName(
          MockData.DEFAULT_URI, LAYER_NAME_WITHOUT_STYLE_DESCRIPTION, MockData.DEFAULT_PREFIX);
  ...
  public void testLayerStyleWithoutTitle() throws Exception {
    ...
    assertXpathEvaluatesTo(
        STYLE_NAME_WITHOUT_TITLE, getLayerStyleTitleXPath(LAYER_NAME_WITHOUT_STYLE_TITLE), dom);
  }
