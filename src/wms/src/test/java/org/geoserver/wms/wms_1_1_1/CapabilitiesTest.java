...
public class CapabilitiesTest extends WMSTestSupport {
  ...
  public void testFilteredCapabilitiesCite() throws Exception {
    ...
    assertEquals(
        0, xpath.getMatchingNodes("//Layer/Name[not(starts-with(., cite))]", dom).getLength());
  }
  ...
  public void testWorkspaceQualified() throws Exception {
    ...
    assertTrue(
        xpath.getMatchingNodes("//Layer/Name[not(starts-with(., 'cite'))]", dom).getLength() > 0);
  ...
  public void testLayerQualified() throws Exception {
    ...
    XpathEngine xpath = XMLUnit.newXpathEngine();
    assertEquals(
        0, xpath.getMatchingNodes("//Layer/Name[starts-with(., 'cite:Forests')]", dom).getLength());
  ...
  public void testLayerGroup() throws Exception {
    ...
    try {
      ...
      assertXpathEvaluatesTo(
          "1", "count(//Layer[Name='MyLayerGroup']/KeywordList[Keyword='keyword1'])", doc);
      assertXpathEvaluatesTo(
          "1", "count(//Layer[Name='MyLayerGroup']/KeywordList[Keyword='keyword2'])", doc);
    } finally {
      // clean up
  ...
  public void testExceptions() throws Exception {
    ...
    assertTrue(
        xpath.evaluate("//Exception/Format[2]", doc).equals("application/vnd.ogc.se_inimage"));
  ...
  private Document findCapabilities(Boolean scaleHintUnitsPerDiaPixel) throws Exception {
    ...
    Capabilities_1_3_0_Transformer tr =
        new Capabilities_1_3_0_Transformer(
            wms, BASE_URL, wms.getAllowedMapFormats(), new HashSet<ExtendedCapabilitiesProvider>());
