...
public class FilterMosaicGetMapTest extends WMSFilterMosaicTestSupport {
  ...
  public void testCaseElev100andIngestion31Oct() throws Exception {
    ...
    BufferedImage image =
        getAsImage(
            BASE_URL + "&cql_filter=elevation=100 AND ingestion=\'2008-10-31T00:00:00.000Z\'",
            "image/png");
  ...
  public void testCaseElev100andIngestion01Nov() throws Exception {
    ...
    BufferedImage image =
        getAsImage(
            BASE_URL + "&cql_filter=elevation=100 AND ingestion=\'2008-11-01T00:00:00.000Z\'",
            "image/png");
  ...
  public void testCaseElev0andIngestion31Oct() throws Exception {
    ...
    BufferedImage image =
        getAsImage(
            BASE_URL + "&cql_filter=elevation=0 AND ingestion=\'2008-10-31T00:00:00.000Z\'",
            "image/png");
  ...
  public void testCaseElev0andIngestion01Nov() throws Exception {
    ...
    BufferedImage image =
        getAsImage(
            BASE_URL + "&cql_filter=elevation=0 AND ingestion=\'2008-11-01T00:00:00.000Z\'",
            "image/png");
