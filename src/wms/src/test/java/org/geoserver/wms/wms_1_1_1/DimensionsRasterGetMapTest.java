...
public class DimensionsRasterGetMapTest extends WMSDimensionsTestSupport {
  ...
  public void testDefaultValues() throws Exception {
    setupRasterDimension(
        WATTEMP, ResourceInfo.ELEVATION, DimensionPresentation.LIST, null, UNITS, UNIT_SYMBOL);
  ...
  public void testTimeNearestClose() throws Exception {
    setupRasterDimension(
        WATTEMP, ResourceInfo.ELEVATION, DimensionPresentation.LIST, null, UNITS, UNIT_SYMBOL);
    setupRasterDimension(
        WATTEMP, ResourceInfo.TIME, DimensionPresentation.LIST, null, ResourceInfo.TIME_UNIT, null);
  ...
  public void testElevationAnimation() throws Exception {
    ...
    List<BufferedImage> images =
        getAsAnimation(
            BASE_URL + "&elevation=-100/500&format=image/gif;subtype=animated", "image/gif");
    assertEquals(2, images.size());
  ...
  public void testTimeElevation() throws Exception {
    ...
    BufferedImage image =
        getAsImage(
            BASE_PNG_URL + "&time=2008-10-31T00:00:00.000Z&elevation=100&bgcolor=0xFF0000",
            "image/png");
  ...
  public void testTimeRange() throws Exception {
    ...
    setupRasterDimension(
        TIMERANGES, ResourceInfo.ELEVATION, DimensionPresentation.LIST, null, UNITS, UNIT_SYMBOL);
    ...
    BufferedImage image =
        getAsImage(
            baseUrl + "&TIME=2008-11-05T00:00:00.000Z/2008-11-06T12:00:00.000Z", "image/png");
    ...
    image =
        getAsImage(
            baseUrl + "&TIME=2008-10-31T12:00:00.000Z/2008-10-31T16:00:00.000Z", "image/png");
    assertPixel(image, 36, 31, Color.BLUE);
  ...
  public void testTimeRangeNearestMatchAcceptableRange() throws Exception {
    ...
    // in the middle hole, closer to the latest value, but with a search radius that will match the
    // earlier one
  ...
  public void testTimeDefaultAsRange() throws Exception {
    ...
    // BufferedImage image = getAsImage(BASE_URL + "&time=2008-10-31T00:00:00.000Z&elevation=100",
    // "image/png");
    BufferedImage image = getAsImage(BASE_PNG_URL + "&elevation=100", "image/png");
