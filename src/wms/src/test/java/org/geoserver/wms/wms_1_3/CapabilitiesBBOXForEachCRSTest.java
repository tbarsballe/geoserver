...
public class CapabilitiesBBOXForEachCRSTest extends WMSTestSupport {
  ...
  public void testRootLayer() throws Exception {
    ...
    assertXpathNotExists(
        "/wms:WMS_Capabilities/wms:Capability/wms:Layer/wms:BoundingBox[@CRS = 'EPSG:4326']", doc);
    assertXpathNotExists(
        "/wms:WMS_Capabilities/wms:Capability/wms:Layer/wms:BoundingBox[@CRS = 'EPSG:3005']", doc);
    assertXpathNotExists(
        "/wms:WMS_Capabilities/wms:Capability/wms:Layer/wms:BoundingBox[@CRS = 'EPSG:3857']", doc);
