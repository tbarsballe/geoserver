...
public class GetFeatureInfoTest extends WMSTestSupport {
  ...
  protected void onSetUp(SystemTestData testData) throws Exception {
    ...
    testData.addVectorLayer(
        SQUARES, Collections.EMPTY_MAP, "squares.properties", GetFeatureInfoTest.class, catalog);
    ...
    testData.addVectorLayer(
        STATES, Collections.emptyMap(), "states.properties", GetFeatureInfoTest.class, catalog);
  ...
  public void testPoint3d() throws Exception {
    ...
    String bbox =
        b.getMinX() + "," + b.getMinY() + "," + b.getMaxX() + "," + b.getMaxY() + "&srs=EPSG:4326";
  ...
  public void testAutoBuffer() throws Exception {
    ...
    // another request that will catch one feature due to the style with a thick stroke, make sure
    // it's in
  ...
  /**
   * The rendering engine has a 10-6 tolerance when evaluating rule scale activation, GetFeatureInfo
   * did not
   *
   * @throws Exception
   */
