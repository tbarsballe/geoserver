...
public class VectorCustomDimensionDefaultValueTest extends WMSTestSupport {
  ...
  public void testDefaultCustomDimDateValueVectorSelector() throws Exception {
    ...
    assertTrue(
        "Default value should be the smallest one", d.getTime() == originallySmallest.getTime());
  ...
  public void testExplicitMaxCustomDimDateValueVectorSelector() throws Exception {
    ...
    assertTrue("Default value is null", d != null);
    assertTrue(
        "Default value should be the biggest one", d.getTime() == originallyBiggest.getTime());
  ...
  public void testExplicitFixedCustomDimDoubleValueVectorSelector() throws Exception {
    ...
    assertTrue("Default value is null", d != null);
    assertTrue(
        "Default value should be the smallest one", Math.abs(d.doubleValue() - fixed) < 0.0001);
  ...
  public void testExplicitNearestToGivenValueCustomDimDateValueVectorSelector() throws Exception {
    ...
    assertTrue("Default value is null", d != null);
    assertTrue(
        "Default value should be the closest one", d.getTime() == originallyBiggest.getTime());
    ...
    assertTrue("Default value is null", d != null);
    assertTrue(
        "Default value should be the closest one", d.getTime() == biggerThanOriginal.getTime());
    ...
    assertTrue("Default value is null", d != null);
    assertTrue(
        "Default value should be the closest one", d.getTime() == biggerThanReference.getTime());
  }
  ...
  private void addFeatureWithScanningAngle(int fid, Double angle) throws IOException {
    this.addFeature(
        fid, Date.valueOf("2013-01-13"), Double.valueOf(0d), Date.valueOf("2014-01-20"), angle);
  }
}
