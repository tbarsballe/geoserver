...
public class WMSTest extends WMSTestSupport {
  ...
  public void testGetTimeElevationToFilterStartEndDate() throws Exception {
    ...
    doTimeElevationFilter(
        new DateRange(Date.valueOf("2012-02-11"), Date.valueOf("2012-02-13")), null, 0, 1, 2);
    // Test start before and end after all ranges.
    doTimeElevationFilter(
        new DateRange(Date.valueOf("2012-02-09"), Date.valueOf("2012-02-14")), null, 0, 1, 2);
    ...
    doTimeElevationFilter(
        new DateRange(Date.valueOf("2012-02-12"), Date.valueOf("2012-02-13")), null, 0, 1, 2);
