...
public class DimensionHelperTest {
  ...
  /**
   * The goal if this test is to verify behavior of a similar, but not complete, format provided by
   * the standard libraries. The incomplete pattern does not support BC dates properly, so we will
   * not test compliance here.
   *
