...
public class CapabilitiesAllowedMimeTypesTest extends WMSTestSupport {
  ...
  public void testAllowedMimeTypes() throws Exception {
    ...
    Document doc =
        getAsDOM(
            "sf/PrimitiveGeoFeature/wms?service=WMS&request=getCapabilities&version=1.1.1", true);
    XpathEngine xpath = XMLUnit.newXpathEngine();

    NodeList formatNodes =
        xpath.getMatchingNodes("/WMT_MS_Capabilities/Capability/Request/GetMap/Format", doc);
