...
public class LegendCapabilitiesTest extends WMSTestSupport {
  ...
  protected void onSetUp(SystemTestData testData) throws Exception {
    ...
    testData.addRasterLayer(
        LAYER_QNAME_WS, LAYER_FILE, null, propertyMapWs, SystemTestData.class, getCatalog());
  ...
  public void testCapabilities() throws Exception {
    ...
    assertXpathEvaluatesTo(
        BASE + "/styles/" + IMAGE_URL, legendUrlPath + "/wms:OnlineResource/@xlink:href", dom);
    ...
    assertXpathEvaluatesTo(
        BASE + "/styles/gs/" + IMAGE_URL, legendUrlPathWs + "/wms:OnlineResource/@xlink:href", dom);
  }
}
