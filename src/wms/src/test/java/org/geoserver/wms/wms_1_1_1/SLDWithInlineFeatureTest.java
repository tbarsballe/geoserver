...
public class SLDWithInlineFeatureTest extends GeoServerSystemTestSupport {
  ...
  public void testSLDWithInlineFeatureWMS() throws Exception {
    BufferedReader reader =
        new BufferedReader(
            new InputStreamReader(getClass().getResourceAsStream("SLDWithInlineFeature.xml")));
    String line;
    ...
    BufferedImage image =
        ImageIO.read(getBinaryInputStream(postAsServletResponse("wms", builder.toString())));
  ...
  public void testGetMapPostEntityExpansion() throws Exception {
    String body =
        IOUtils.toString(getClass().getResourceAsStream("GetMapExternalEntity.xml"), "UTF-8");
