...
public abstract class GetCapabilitiesLegendURLTest extends WMSTestSupport {
   ...
   * WMSInfo}, {@link GeoServerInfo} and empty {@link Catalog}, Specific tests should add content as
   * needed
   */
  ...
  /**
   * a mocked up {@link Catalog} for {@link #geosConfig}, empty after setUp(), Specific tests should
  ...
  protected void onSetUp(SystemTestData testData) throws Exception {
    ...
    new File(
            dataDirRoot.getAbsolutePath() + File.separator + LegendSampleImpl.LEGEND_SAMPLES_FOLDER)
        .mkdir();
    ...
    testData.addStyle(
        workspaceInfo, "states", "Population.sld", GetCapabilitiesLegendURLTest.class, catalog);
    ...
    testData.addVectorLayer(
        STATES, properties, "states.properties", GetCapabilitiesLegendURLTest.class, catalog);
